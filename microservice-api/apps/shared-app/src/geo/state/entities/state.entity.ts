...
const StateEntityFieldMeta: EntityMetaCRUDTypeDefinition = {
  id: {
      desc: `Unique ID of the state, auto generated.`,
      validation: {}
  },
  country_id: {
      desc: `Required to get state for specifc country.`,
      validation: {}
  },
  name: {
      ...
      validation: {
        maxLength: 64,
        maxLengthMsg: `Name of the state length is only 64 characters.`,
      }
  },
  type: {
      desc: `Type of the state.`,
      validation: {
        maxLength: 128,
        maxLengthMsg: `Type of the state length is only 128 characters.`,
      }
  },
  fips: {
      desc: `FIPS code of the state.`,
      validation: {
        maxLength: 128,
        maxLengthMsg: `FIPS code of the state length is only 128 characters.`,
      }
  },
  iso_ii: {
      desc: `ISO II code of the state.`,
      validation: {
        maxLength: 128,
        maxLengthMsg: `ISO II code of the state length is only 128 characters.`,
      }
  },
  latitude: {
      desc: `Latitude of the state.`,
      validation: {}
  },
  longitude: {
      desc: `Longitude of the state.`,
      validation: {}
  },
  created: {
...
export const StateEntityMeta = {...StateEntityFieldMeta, ...StateVirtualFieldMeta};
const meta = StateEntityMeta; // need to use in this file down the line
