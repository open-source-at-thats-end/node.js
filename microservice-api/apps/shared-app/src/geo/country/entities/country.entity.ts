...
const  CountryEntityFieldMeta: EntityMetaCRUDTypeDefinition = {

  id: {
      desc: `Unique ID of the country, auto generated.`,
      validation: {} 
      
  },
  region_id: {
      desc: `Region ID of the country.`,
      validation: {}
  },
  subregion_id: {
      desc: `Subregion ID of the country.`,
      validation: {}
  },
  name: {
      ...
      validation: {
        maxLength: 64,
        maxLengthMsg: `Name of the country length is only 64 characters.`,
      }  
  },
  numeric_code: {
      desc: `Numeric code of the country.`,
      validation: {
        maxLength: 3,
        maxLengthMsg: `Numeric code of the country length is only 3 characters.`,
      }
  },
  iso_iii: {
      desc: `ISO III code of the country.`,
      validation: {
        maxLength: 3,
        maxLengthMsg: `ISO III code of the country length is only 3 characters.`,
      }
  },
  iso_ii: {
      desc: `ISO II code of the country.`,
      validation: {
        maxLength: 2,
        maxLengthMsg: `ISO II code of the country length is only 2 characters.`,
      }
  },
  fips: {
    desc: `FIPS code of the country.`,
    validation: {
      maxLength: 3,
      maxLengthMsg: `FIPS code of the country length is only 3 characters.`,
    }
  },
  phone_code: {
    desc: `Phone code of the country.`,
    validation: {
      maxLength: 16,
      maxLengthMsg: `Phone code of the country length is only 16 characters.`,
    }
  },
  subdivision_title: {
      desc: `Subdivision title of the country.`,
      validation: {
        maxLength: 64,
        maxLengthMsg: `Subdivision title of the country length is only 64 characters.`,
      }
  },
  capital: {
      desc: `Capital of the country.`,
      validation: {
        maxLength: 64,
        maxLengthMsg: `Capital of the country length is only 64 characters.`,
      }
  },
  currency: {
      desc: `Currency code of the country.`,
      validation: {
        maxLength: 3,
        maxLengthMsg: `Currency code of the country length is only 3 characters.`,
      }
  },
  currency_name: {
      desc: `Currency name of the country.`,
      validation: {
        maxLength: 64,
        maxLengthMsg: `Currency name of the country length is only 64 characters.`,
      }
  },
  currency_symbol: {
      desc: `Currency symbol of the country.`,
      validation: {
        maxLength: 16,
        maxLengthMsg: `Currency symbol of the country length is only 16 characters.`,
      }
  },
  tld: {
      desc: `TLD of the country.`,
      validation: {
        maxLength: 16,
        maxLengthMsg: `TLD of the country length is only 16 characters.`,
      }
  },
  native: {
      ...
      validation: {
        maxLength: 64,
        maxLengthMsg: `Native name of the country length is only 64 characters.`,
      }
  },
  nationality: {
      desc: `Nationality of the country.`,
      validation: {
        maxLength: 64,
        maxLengthMsg: `Nationality of the country length is only 64 characters.`,
      }
  },
  timezones: {
      desc: `List of timezones in the country.`,
      validation: {}
  },
  translations: {
      desc: `Translations of the country name in different languages.`,
      validation: {}
  },
  latitude: {
      desc: `Latitude of the country.`,
      validation: {}
  },
  longitude: {
      desc: `Longitude of the country.`,
      validation: {}
  },
  emoji: {
      desc: `Emoji of the country.`,
      validation: {
        maxLength: 128,
        maxLengthMsg: `Emoji of the country length is only 128 characters.`,
      }
  },
  emoji_u: {
      desc: `Emoji U of the country.`,
      validation: {
        maxLength: 128,
        maxLengthMsg: `Emoji U of the country length is only 128 characters.`,
      }
  },
  created: {
...
export const CountryEntityMeta = {...CountryEntityFieldMeta, ...CountryVirtualFieldMeta};
const meta = CountryEntityMeta; // need to use in this file down the line
