...
const  ProcessedSearchByMapSearchEntityFieldMeta: EntityMetaCRUDTypeDefinition = {

    id: {
      desc: 'Id of the processed search by mapsearch',
      validation: {}
    },
    mls_num: {
      desc: 'Mls num of the processed search by mapsearch',
      validation: {
        maxLength:255,
        maxLengthMsg: "Maximum length of map search is 255 characters.",
      }
    },
    mlsp_id: {
    ...
    listing_key: {
      desc: 'Listing key of the processed search by mapsearch',
      validation: {
        maxLength:20,
    ...
    agent_id: {
      desc: 'Agent id of the processed search by mapsearch',
      validation: {
        maxLength:20,
    ...
    agent_short_id: {
      desc: 'Agent short id of the processed search by mapsearch',
      validation: {
        maxLength:20,
        maxLengthMsg: "Maximum length of agent short id is 20 characters.",
      }
    },
    co_agent_id: {
      desc: 'Co agent id of the processed search by mapsearch',
      validation: {
        maxLength:20,
    ...
    office_id: {
      desc: 'Office id of the processed search by mapsearch',
      validation: {
        maxLength:20,
    ...
    co_office_id: {
      desc: 'Co office id of the processed search by mapsearch',
      validation: {
        maxLength:20,
    ...
    co_agent_short_id: {
      desc: 'Co agent short id of the processed search by mapsearch',
      validation: {
        maxLength:20,
        maxLengthMsg: "Maximum length of co agent short id is 20 characters.",
      }
    },
    sell_agent_short_id: {
      desc: 'Sell agent short id of the processed search by mapsearch',
      validation: {
        maxLength:20,
        maxLengthMsg: "Maximum length of sell agent short id is 20 characters.",
      }
    },
    buy_agent_id: {
      desc: 'Buy agent id of the processed search by mapsearch',
      validation: {
        maxLength:20,
        maxLengthMsg: "Maximum length of buy agent id is 20 characters.",
      }
    },
    co_buy_agent_id: {
      desc: 'Co buy agent id of the processed search by mapsearch',
      validation: {
        maxLength:20,
        maxLengthMsg: "Maximum length of co buy agent id is 20 characters.",
      }
    },
    property_type: {
      desc: 'Property type of the processed search by mapsearch',
      validation: {
        maxLength:20,
    ...
    property_style: {
      desc: 'Property style of the processed search by mapsearch',
      validation: {
        maxLength:255,
        maxLengthMsg: "Maximum length of property style is 55 characters.",
      }
    },
    category: {
      desc: 'Category of the processed search by mapsearch',
      validation: {
        maxLength:10,
        maxLengthMsg: "Maximum length of category is 10 characters.",
      }
    },
    property_status: {
      desc: 'Property status of the processed search by mapsearch',
      validation: {
        maxLength:20,
    ...
    subtype: {
      desc: 'Subtype of the processed search by mapsearch',
      validation: {
        maxLength:30,
    ...
    baths_full: {
      desc: 'Baths full of the processed search by mapsearch',
      validation: {}
    },
    baths_half: {
      desc: 'Baths half of the processed search by mapsearch',
      validation: {}
    },
    baths: {
      desc: 'Baths of the processed search by mapsearch',
      validation: {}
    },
    beds: {
      desc: 'Beds of the processed search by mapsearch',
      validation: {}
    },
    list_price: {
      desc: 'List price of the processed search by mapsearch',
      validation: {}
    },
    original_list_price: {
      desc: 'Original list price of the processed search by mapsearch',
      validation: {}
    },
    sold_price: {
      desc: 'Sold price of the processed search by mapsearch',
      validation: {
        maxLength:16,
        maxLengthMsg: "Maximum length of sold price is 16 characters.",
      }
    },
    sold_date: {
      desc: 'Sold date of the processed search by mapsearch',
      validation: {}
    },
    sqft: {
      desc: 'Sqft of the processed search by mapsearch',
      validation: {}
    },
    yearbuilt: {
      desc: 'Yearbuilt of the processed search by mapsearch',
      validation: {}
    },
    total_photos: {
      desc: 'Total photos of the processed search by mapsearch',
      validation: {}
    },
    main_photo: {
      desc: 'Main photo of the processed search by mapsearch',
      validation: {}
    },
    main_photo_url: {
      desc: 'Main photo url of the processed search by mapsearch',
      validation: {
        
      }
    },
    display_address: {
      desc: 'Display address of the processed search by mapsearch',
      validation: {
        maxLength:1,
    ...
    listing_date: {
      desc: 'Listing date of the processed search by mapsearch',
      validation: {}
    },
    last_update_date: {
      desc: 'Last update date of the processed search by mapsearch',
      validation: {
      }
    },
    elementary_school: {
      desc: 'Elementary school of the processed search by mapsearch',
      validation: {
        maxLength:50,
    ...
    high_school: {
      desc: 'High school of the processed search by mapsearch',
      validation: {
        maxLength:50,
    ...
    middle_school: {
      desc: 'Middle school of the processed search by mapsearch',
      validation: {
        maxLength:50,
    ...
    price_diff: {
      desc: 'Price diff of the processed search by mapsearch',
      validation: {}
    },
    system_name: {
      desc: 'System name of the processed search by mapsearch',
      validation: {
        maxLength:255,
        maxLengthMsg: "Maximum length of system name is 255 characters.",
      }
    },
    address: {
      desc: 'Address of the processed search by mapsearch',
      validation: {
        maxLength:255,
    ...
    area: {
      desc: 'Area of the processed search by mapsearch',
      validation: {
        maxLength:150,
    ...
    subdivision: {
      desc: 'Subdivision of the processed search by mapsearch',
      validation: {
        maxLength:150,
    ...
    unit_no: {
      desc: 'Unit no of the processed search by mapsearch',
      validation: {
        maxLength:25,
    ...
    street_number: {
      desc: 'Street number of the processed search by mapsearch',
      validation: {
        maxLength:25,
    ...
    street_direction: {
      desc: 'Street direction of the processed search by mapsearch',
      validation: {
        maxLength:10,
        maxLengthMsg: "Maximum length of street direction is 10 characters.",
      }
    },
    street_dir_prefix: {
      desc: 'Street dir prefix of the processed search by mapsearch',
      validation: {
        maxLength:25,
    ...
    street_name: {
      desc: 'Street name of the processed search by mapsearch',
      validation: {
        maxLength:50,
    ...
    street_suffix: {
      desc: 'Street suffix of the processed search by mapsearch',
      validation: {
        maxLength:20,
        maxLengthMsg: "Maximum length of street suffix is 20 characters.",
      }
    },
    street_dir_suffix: {
      desc: 'Street dir suffix of the processed search by mapsearch',
      validation: {
        maxLength:25,
    ...
    city_name: {
      desc: 'City name of the processed search by mapsearch',
      validation: {
        maxLength:50,
    ...
    state: {
      desc: 'State of the processed search by mapsearch',
      validation: {
        maxLength:3,
        maxLengthMsg: "Maximum length of State is 3 characters.",
      }
    },
    county: {
      desc: 'County of the processed search by mapsearch',
      validation: {
        maxLength:50,
    ...
    zipcode: {
      desc: 'Zipcode of the processed search by mapsearch',
      validation: {
        maxLength:10,
    ...
    latitude: {
      desc: 'Latitude of the processed search by mapsearch',
      validation: {}
    },
    longitude: {
      desc: 'Longitude of the processed search by mapsearch',
      validation: {}
    },
    lotsize_sqft: {
      desc: 'Lotsize sqft of the processed search by mapsearch',
      validation: {}
    },
    is_hoa: {
      desc: 'Is hoa of the processed search by mapsearch',
      validation: {
        maxLength:1,
        maxLengthMsg: "Maximum length of is hoa is 1 characters.",
      }
    },
    is_new: {
      desc: 'Is new of the processed search by mapsearch',
      validation: {
        maxLength:1,
        maxLengthMsg: "Maximum length of is new is 1 characters.",
      }
    },
    pool_desc: {
      desc: 'Pool desc of the processed search by mapsearch',
      validation: {
        
      }
    },
    pets_allowed: {
      desc: 'Pets allowed of the processed search by mapsearch',
      validation: {
      }
    },
    furnished: {
      desc: 'Furnished of the processed search by mapsearch',
      validation: {
        maxLength:25,
    ...
    is_waterfront: {
      desc: 'Is waterfront of the processed search by mapsearch',
      validation: {
        maxLength:1,
    ...
    waterfront_desc: {
      desc: 'Waterfront desc of the processed search by mapsearch',
      validation: {
      }
    },
    horse_yn: {
      desc: 'Horse yn of the processed search by mapsearch',
      validation: {
        maxLength:1,
        maxLengthMsg: "Maximum length of horse yn is 1 characters.",
      }
    },
    horse_amenities: {
      desc: 'Horse amenities of the processed search by mapsearch',
      validation: {
       
      }
    },
    security_safety: {
      desc: 'Security safety of the processed search by mapsearch',
      validation: {
      }
    },
    membership_required_yn: {
      desc: 'Membership required yn of the processed search by mapsearch',
      validation: {
        maxLength:1,
        maxLengthMsg: "Maximum length of membership required yn is 1 characters.",
      }
    },
    membership: {
      desc: 'Membership of the processed search by mapsearch',
      validation: {
        
      }
    },
    membership_fee: {
      desc: 'Membership fee of the processed search by mapsearch',
      validation: {
        
      }
    },
    virtual_tour_url: {
      desc: 'Virtual tour url of the processed search by mapsearch',
      validation: {}
    },
    description: {
      desc: 'Description of the processed search by mapsearch',
      validation: {}
    },
    exterior_features: {
      desc: 'Exterior features of the processed search by mapsearch',
      validation: {
      }
    },
    building_features: {
      desc: 'Building features of the processed search by mapsearch',
      validation: {
       
      }
    },
    construction: {
      desc: 'Construction of the processed search by mapsearch',
      validation: {}
    },
    sewer: {
      desc: 'Sewer of the processed search by mapsearch',
      validation: {}
    },
    water: {
      desc: 'Water of the processed search by mapsearch',
      validation: {
        maxLength:50,
        maxLengthMsg: "Maximum length of water is 50 characters.",
      }
    },
    zoning: {
      desc: 'Zoning of the processed search by mapsearch',
      validation: {
        maxLength:25,
        maxLengthMsg: "Maximum length of water is 25 characters.",
      }
    },
    legal: {
      desc: 'Legal of the processed search by mapsearch',
      validation: {}
    },
    fireplace_features: {
      desc: 'Fireplace features of the processed search by mapsearch',
      validation: {}
    },
    amenities: {
      desc: 'Amenities of the processed search by mapsearch',
      validation: {}
    },
    cooling: {
      desc: 'Cooling of the processed search by mapsearch',
      validation: {}
    },
    appliances: {
      desc: 'Appliances of the processed search by mapsearch',
      validation: {}
    },
    flooring: {
      desc: 'Flooring of the processed search by mapsearch',
      validation: {}
    },
    heating: {
      desc: 'Heating of the processed search by mapsearch',
      validation: {}
    },
    interior_features: {
      desc: 'Interior features of the processed search by mapsearch',
      validation: {}
    },
    roof: {
      desc: 'Roof of the processed search by mapsearch',
      validation: {}
    },
    spa_features: {
      desc: 'Spa features of the processed search by mapsearch',
      validation: {
        maxLength:255,
        maxLengthMsg: "Maximum length of spa features is 255 characters.",
      }
    },
    community_features: {
      desc: 'Community features of the processed search by mapsearch',
      validation: {}
    },
    parking_features: {
      desc: 'Parking features of the processed search by mapsearch',
      validation: {}
    },
    mls_is_pic_url_supported: {
      desc: 'Mls is pic url supported of the processed search by mapsearch',
      validation: {
        maxLength:3,
        maxLengthMsg: "Maximum length of mls is pic url supported is 3 characters.",
      }
    },
    dom: {
      desc: 'Dom of the processed search by mapsearch',
      validation: {}
    },
    office_name: {
      desc: 'Office name of the processed search by mapsearch',
      validation: {
        maxLength:64,
        maxLengthMsg: "Maximum length of office name is 64 characters.",
      }
    },
    created: {
...
export const ProcessedSearchByMapSearchEntityMeta = {...ProcessedSearchByMapSearchEntityFieldMeta, ...ProcessedSearchByMapSearchVirtualFieldMeta};
const meta = ProcessedSearchByMapSearchEntityMeta; // need to use in this file down the line
