...
const  ProcessedSearchByMlsEntityFieldMeta: EntityMetaCRUDTypeDefinition = {

    id: {
        desc: 'Unique ID of the processed search by mls, auto generated.',
        validation: {} 
    },
    mlsp_id: {
        desc: 'MLSP ID',
    ...
    mls_num: {
      desc: 'Mls num of the processed search by mls',
      validation:{
        maxLength:16,
    ...
    property_type: {
      desc: 'Property type of the processed search by mls',
      validation:{
        maxLength:32,
    ...
    property_status: {
      desc: 'Property state of the processed search by mls',
      validation:{
        maxLength:16,
        maxLengthMsg: "Maximum length of property state is 16 characters.",
      }
    },
    created: {
...
export const ProcessedSearchByMlsEntityMeta = {...ProcessedSearchByMlsEntityFieldMeta, ...ProcessedSearchByMlsVirtualFieldMeta};
const meta = ProcessedSearchByMlsEntityMeta; // need to use in this file down the line

@ObjectType({ isAbstract: true })
@Directive('@key(fields: "id")')
@Entity({
  name: 'rets_processed_search_by_mls',
  engine: 'InnoDB',
})
