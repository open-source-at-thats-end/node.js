...
import { FaqCategoryEntityMeta as meta, FaqCategoryEntity } from "../entities/category.entity";
...
import { FaqCategoryUploadFileFieldEnum } from "../category.enum";
import { FaqFindInputWhereDto } from "../../faq/dto/faq.dto";
...
@Directive('@shareable')
export class FaqCategoryDto extends FaqCategoryEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class FaqCategoryFindDto extends FaqCategoryEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class FaqCategoryFindInputWhereDto extends FaqCategoryDto implements FindInputWhereCRUDTypeDefinition{
  ...
  // ████ FR_ WHERE: INTERNAL RELATIONS WHERE ████████████████████████████████████████████████  
    ...
    @Field(() => [FaqFindInputWhereDto], {nullable: true, description: meta?.fr_faq_category.desc})
    @IsOptional()
    declare fr_faq_category?: FaqFindInputWhereDto[];
}

@InputType()
export class FaqCategoryFindInputSortOrderDto implements FindOptionsOrder<FaqCategoryDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class FaqCategoryFindInputGroupByDto implements FindOptionsOrder<FaqCategoryDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class FaqCategoryFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<FaqCategoryDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [FaqCategoryFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<FaqCategoryFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => FaqCategoryFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
     ...
     */
    @Field(() => FaqCategoryFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<FaqCategoryFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryFindOutputRowsDto extends FaqCategoryFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class FaqCategoryFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [FaqCategoryEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: FaqCategoryEntity | FaqCategoryEntity[] | any;
}
...
export class FaqCategoryFindOneByIdDto extends FaqCategoryEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class FaqCategoryFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class FaqCategoryCreateDto extends FaqCategoryEntity implements CreateDtoCRUDTypeDefinition {
...
@InputType()
export class FaqCategoryCreateInputDto extends  FaqCategoryCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryCreateOutputDto extends FaqCategoryFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class FaqCategoryUpdateDto extends FaqCategoryDto implements UpdateDtoCRUDTypeDefinition{
...
@InputType()
export class FaqCategoryUpdateInputWhereDto extends FaqCategoryFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class FaqCategoryUpdateInputSetsDto extends PartialType(FaqCategoryCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class FaqCategoryUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [FaqCategoryUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<FaqCategoryUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => FaqCategoryUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: FaqCategoryUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryUpdateOutputAffectedRowsDto extends FaqCategoryFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [FaqCategoryEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: FaqCategoryEntity[] | any; 
}
...
export class FaqCategorySoftDeleteDto extends FaqCategoryEntity implements SoftDeleteDtoCRUDTypeDefinition{
...
@InputType()
export class FaqCategorySoftDeleteInputWhereDto extends FaqCategoryFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class FaqCategorySoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [FaqCategorySoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FaqCategorySoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FaqCategorySoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FaqCategoryDeleteDto extends FaqCategoryEntity implements DeleteDtoCRUDTypeDefinition{
...
@InputType()
export class FaqCategoryDeleteInputWhereDto extends FaqCategoryFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class FaqCategoryDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [FaqCategoryDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FaqCategoryDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FaqCategoryRestoreDto extends FaqCategoryEntity implements RestoreDtoCRUDTypeDefinition{
...
@InputType()
export class FaqCategoryRestoreInputWhereDto extends FaqCategoryFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class FaqCategoryRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [FaqCategoryRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FaqCategoryRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FaqCategoryUpsertDto extends FaqCategoryEntity implements UpsertDtoCRUDTypeDefinition{
...
@InputType()
export class FaqCategoryUpsertInputDto extends FaqCategoryCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof FaqCategoryUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryUpsertOutputDto extends IntersectionType(FaqCategoryCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class FaqCategorySoftRemoveDto extends FaqCategoryEntity implements SoftRemoveDtoCRUDTypeDefinition{
...
@InputType()
export class FaqCategorySoftRemoveInputWhereDto extends FaqCategoryFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class FaqCategorySoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [FaqCategorySoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FaqCategorySoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FaqCategorySoftRemoveOutputAffectedRowsDto extends FaqCategoryFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class FaqCategorySoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FaqCategoryRemoveDto extends FaqCategoryEntity implements RemoveDtoCRUDTypeDefinition{
...
@InputType()
export class FaqCategoryRemoveInputWhereDto extends FaqCategoryFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class FaqCategoryRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [FaqCategoryRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FaqCategoryRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryRemoveOutputAffectedRowsDto extends FaqCategoryFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FaqCategoryRecoverDto extends FaqCategoryEntity implements RecoverDtoCRUDTypeDefinition{
...
@InputType()
export class FaqCategoryRecoverInputWhereDto extends FaqCategoryFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class FaqCategoryRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [FaqCategoryRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FaqCategoryRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryRecoverOutputAffectedRowsDto extends FaqCategoryFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FaqCategoryUploadDto extends FaqCategoryEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${FaqCategoryEntity?.metaname}${UploadArtefact}`;
...
@Field(() => FaqCategoryUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: FaqCategoryUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class FaqCategoryUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class FaqCategoryUploadDeleteDto extends FaqCategoryEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${FaqCategoryEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class FaqCategoryUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class FaqCategoryUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
