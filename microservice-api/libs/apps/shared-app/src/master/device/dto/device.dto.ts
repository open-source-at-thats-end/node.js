...
import { DeviceEntityMeta as meta, DeviceEntity } from "../entities/device.entity";
...
import { DeviceUploadFileFieldEnum } from "../device.enum";
import { UserDeviceFindInputWhereDto } from "apps/shared-app/src/folk/user-device/dto/user.device.dto";
import { SessionFindInputWhereDto } from "apps/shared-app/src/session/dto/session.dto";
import { SettingFindInputWhereDto } from "apps/shared-app/src/settings/setting/dto/setting.dto";
...
@Directive('@shareable')
export class DeviceDto extends DeviceEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class DeviceFindDto extends DeviceEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class DeviceFindInputWhereDto extends DeviceDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.os.desc})
    @IsOptional()
    declare os?: FindOperatorDto;

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.interface.desc})
    @IsOptional()
    declare interface?: FindOperatorDto;

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.approved.desc})
    @IsOptional()
    ...
    @Field(() => [UserDeviceFindInputWhereDto], {nullable: true, description: meta?.fr_device_users.desc})
    @IsOptional()
    declare fr_device_users?: UserDeviceFindInputWhereDto[];

    @Field(() => [SessionFindInputWhereDto], {nullable: true, description: meta?.fr_sessions.desc})
    @IsOptional()
    ...
    @Field(() => [LeadFindInputWhereDto], {nullable: true, description: meta?.fr_setting.desc})
    @IsOptional()
    declare fr_leads?: LeadFindInputWhereDto[];

    @Field(() => [NewsLetterTrackLogFindInputWhereDto], {nullable: true, description: meta?.fr_setting.desc})
    @IsOptional()
    declare fr_newsletter_tracking_logs_info?: NewsLetterTrackLogFindInputWhereDto[];
}

@InputType()
export class DeviceFindInputSortOrderDto implements FindOptionsOrder<DeviceDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class DeviceFindInputGroupByDto implements FindOptionsOrder<DeviceDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class DeviceFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<DeviceDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [DeviceFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where})
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<DeviceFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => DeviceFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
     ...
     */
    @Field(() => DeviceFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<DeviceFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class DeviceFindOutputRowsDto extends DeviceFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class DeviceFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [DeviceFindOutputRowsDto], {description:CrudDefMetaDesc.find_rows})
    declare rows?: DeviceFindOutputRowsDto | DeviceFindOutputRowsDto[] | any;
}
...
export class DeviceFindOneByIdDto extends DeviceEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class DeviceFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class DeviceCreateDto extends DeviceEntity implements CreateDtoCRUDTypeDefinition {
...
@InputType()
export class DeviceCreateInputDto extends  DeviceCreateDto implements CreateInputCRUDTypeDefinition {
  
    @Field(() => String, {nullable: false, description: meta?.name.desc})
    declare name?: string;

    @Field(() => String, {nullable: false, description: meta?.os.desc})
    declare os?: string;

    @Field(() => String, {nullable: false, description: meta?.interface.desc})
    declare interface?: string;

    @Field(() => String, {nullable: false, description: meta?.user_agent.desc})
...
@ObjectType()
@Directive('@shareable')
export class DeviceCreateOutputDto extends DeviceFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class DeviceUpdateDto extends DeviceDto implements UpdateDtoCRUDTypeDefinition{
...
@InputType()
export class DeviceUpdateInputWhereDto extends DeviceFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class DeviceUpdateInputSetsDto extends PartialType(DeviceCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class DeviceUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [DeviceUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<DeviceUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => DeviceUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    sets!: DeviceUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class DeviceUpdateOutputAffectedRowsDto extends DeviceFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class DeviceUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [DeviceUpdateOutputAffectedRowsDto], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: DeviceUpdateOutputAffectedRowsDto[] | any; 
}
...
export class DeviceSoftDeleteDto extends DeviceEntity implements SoftDeleteDtoCRUDTypeDefinition{
...
@InputType()
export class DeviceSoftDeleteInputWhereDto extends DeviceFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class DeviceSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [DeviceSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<DeviceSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class DeviceSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class DeviceDeleteDto extends DeviceEntity implements DeleteDtoCRUDTypeDefinition{
...
@InputType()
export class DeviceDeleteInputWhereDto extends DeviceFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class DeviceDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [DeviceDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<DeviceDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class DeviceDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class DeviceRestoreDto extends DeviceEntity implements RestoreDtoCRUDTypeDefinition{
...
@InputType()
export class DeviceRestoreInputWhereDto extends DeviceFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class DeviceRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [DeviceRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<DeviceRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class DeviceRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class DeviceUpsertDto extends DeviceEntity implements UpsertDtoCRUDTypeDefinition{
...
@InputType()
export class DeviceUpsertInputDto extends DeviceCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof DeviceUpsertInputDto)[] = ['name', 'os','interface'];
}
...
@ObjectType()
@Directive('@shareable')
export class DeviceUpsertOutputDto extends IntersectionType(DeviceCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class DeviceSoftRemoveDto extends DeviceEntity implements SoftRemoveDtoCRUDTypeDefinition{
...
@InputType()
export class DeviceSoftRemoveInputWhereDto extends DeviceFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class DeviceSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [DeviceSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<DeviceSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class DeviceSoftRemoveOutputAffectedRowsDto extends DeviceFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class DeviceSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [DeviceSoftRemoveOutputAffectedRowsDto]) 
  declare affectedRows?: DeviceSoftRemoveOutputAffectedRowsDto[] | any
}
...
export class DeviceRemoveDto extends DeviceEntity implements RemoveDtoCRUDTypeDefinition{
...
@InputType()
export class DeviceRemoveInputWhereDto extends DeviceFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class DeviceRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [DeviceRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<DeviceRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class DeviceRemoveOutputAffectedRowsDto extends DeviceFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class DeviceRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [DeviceRemoveOutputAffectedRowsDto]) 
  declare affectedRows?: DeviceRemoveOutputAffectedRowsDto[] | any;
}
...
export class DeviceRecoverDto extends DeviceEntity implements RecoverDtoCRUDTypeDefinition{
...
@InputType()
export class DeviceRecoverInputWhereDto extends DeviceFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class DeviceRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [DeviceRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<DeviceRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class DeviceRecoverOutputAffectedRowsDto extends DeviceFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class DeviceRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [DeviceRecoverOutputAffectedRowsDto]) 
  declare affectedRows?: DeviceRecoverOutputAffectedRowsDto[] | any;
}
...
export class DeviceUploadDto extends DeviceEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${DeviceEntity?.metaname}${UploadArtefact}`;
...
@Field(() => DeviceUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: DeviceUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class DeviceUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class DeviceUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class DeviceUploadDeleteDto extends DeviceEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${DeviceEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class DeviceUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class DeviceUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
