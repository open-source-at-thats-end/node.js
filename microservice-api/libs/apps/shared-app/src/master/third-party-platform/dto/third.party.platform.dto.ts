...
import { ThirdPartyPlatformEntityMeta as meta, ThirdPartyPlatformEntity } from "../entities/third.party.platform.entity";
...
import { ThirdPartyPlatformUploadFileFieldEnum } from "../third.party.platform.enum";
...
@Directive('@shareable')
export class ThirdPartyPlatformDto extends ThirdPartyPlatformEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class ThirdPartyPlatformFindDto extends ThirdPartyPlatformEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformFindInputWhereDto extends ThirdPartyPlatformDto implements FindInputWhereCRUDTypeDefinition{
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.id.desc})
    @IsOptional()
    declare id?: FindOperatorDto;    

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.slug.desc})
    @IsOptional()
    ...
    declare deleted?: FindOperatorDto;
     ...
     @Field(() => [WebhookResponseFindInputWhereDto], {nullable: true, description: meta?.fr_webhook_responses.desc})
     @IsOptional()
     declare fr_webhook_responses?: WebhookResponseFindInputWhereDto[];
}

@InputType()
export class ThirdPartyPlatformFindInputSortOrderDto implements FindOptionsOrder<ThirdPartyPlatformDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformFindInputGroupByDto implements FindOptionsOrder<ThirdPartyPlatformDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<ThirdPartyPlatformDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [ThirdPartyPlatformFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<ThirdPartyPlatformFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => ThirdPartyPlatformFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
     ...
     */
    @Field(() => ThirdPartyPlatformFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<ThirdPartyPlatformFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformFindOutputRowsDto extends ThirdPartyPlatformFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [ThirdPartyPlatformEntity], {description:CrudDefMetaDesc.find_rows})
    declare rows?: ThirdPartyPlatformEntity | ThirdPartyPlatformEntity[] | any;
}
...
export class ThirdPartyPlatformFindOneByIdDto extends ThirdPartyPlatformEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class ThirdPartyPlatformCreateDto extends ThirdPartyPlatformEntity implements CreateDtoCRUDTypeDefinition {
...
@InputType()
export class ThirdPartyPlatformCreateInputDto extends  ThirdPartyPlatformCreateDto implements CreateInputCRUDTypeDefinition {
  
    @Field(() => String, {nullable: false, description: meta?.slug.desc})
    declare slug?: string;
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformCreateOutputDto extends ThirdPartyPlatformFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class ThirdPartyPlatformUpdateDto extends ThirdPartyPlatformDto implements UpdateDtoCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformUpdateInputWhereDto extends ThirdPartyPlatformFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class ThirdPartyPlatformUpdateInputSetsDto extends PartialType(ThirdPartyPlatformCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class ThirdPartyPlatformUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [ThirdPartyPlatformUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<ThirdPartyPlatformUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => ThirdPartyPlatformUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: ThirdPartyPlatformUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformUpdateOutputAffectedRowsDto extends ThirdPartyPlatformFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [ThirdPartyPlatformEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: ThirdPartyPlatformEntity[] | any; 
}
...
export class ThirdPartyPlatformSoftDeleteDto extends ThirdPartyPlatformEntity implements SoftDeleteDtoCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformSoftDeleteInputWhereDto extends ThirdPartyPlatformFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class ThirdPartyPlatformSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [ThirdPartyPlatformSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ThirdPartyPlatformSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ThirdPartyPlatformDeleteDto extends ThirdPartyPlatformEntity implements DeleteDtoCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformDeleteInputWhereDto extends ThirdPartyPlatformFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class ThirdPartyPlatformDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [ThirdPartyPlatformDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ThirdPartyPlatformDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ThirdPartyPlatformRestoreDto extends ThirdPartyPlatformEntity implements RestoreDtoCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformRestoreInputWhereDto extends ThirdPartyPlatformFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class ThirdPartyPlatformRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [ThirdPartyPlatformRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ThirdPartyPlatformRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ThirdPartyPlatformUpsertDto extends ThirdPartyPlatformEntity implements UpsertDtoCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformUpsertInputDto extends ThirdPartyPlatformCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof ThirdPartyPlatformUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformUpsertOutputDto extends IntersectionType(ThirdPartyPlatformCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class ThirdPartyPlatformSoftRemoveDto extends ThirdPartyPlatformEntity implements SoftRemoveDtoCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformSoftRemoveInputWhereDto extends ThirdPartyPlatformFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class ThirdPartyPlatformSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [ThirdPartyPlatformSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ThirdPartyPlatformSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformSoftRemoveOutputAffectedRowsDto extends ThirdPartyPlatformFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [ThirdPartyPlatformEntity]) 
  declare affectedRows?: ThirdPartyPlatformEntity[] | any
}
...
export class ThirdPartyPlatformRemoveDto extends ThirdPartyPlatformEntity implements RemoveDtoCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformRemoveInputWhereDto extends ThirdPartyPlatformFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class ThirdPartyPlatformRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [ThirdPartyPlatformRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ThirdPartyPlatformRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformRemoveOutputAffectedRowsDto extends ThirdPartyPlatformFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ThirdPartyPlatformRecoverDto extends ThirdPartyPlatformEntity implements RecoverDtoCRUDTypeDefinition{
...
@InputType()
export class ThirdPartyPlatformRecoverInputWhereDto extends ThirdPartyPlatformFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class ThirdPartyPlatformRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [ThirdPartyPlatformRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ThirdPartyPlatformRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformRecoverOutputAffectedRowsDto extends ThirdPartyPlatformFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ThirdPartyPlatformUploadDto extends ThirdPartyPlatformEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${ThirdPartyPlatformEntity?.metaname}${UploadArtefact}`;
...
@Field(() => ThirdPartyPlatformUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: ThirdPartyPlatformUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class ThirdPartyPlatformUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class ThirdPartyPlatformUploadDeleteDto extends ThirdPartyPlatformEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${ThirdPartyPlatformEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class ThirdPartyPlatformUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class ThirdPartyPlatformUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
