...
import { FormFieldEntityMeta as meta, FormFieldEntity } from "../entities/form.field.entity";
...
import { FormFieldUploadFileFieldEnum } from "../form.field.enum";
...
/**
 * # [done] ['../entities/form.control.type.entity', './dto/form.control.type.dto'] . Hint: find [ /form.control.type. => and replace with ] [ /your-module. ] 
 * # [done] do not break some dependences which required this class
 * # [done] module [FormField]
...
@Directive('@shareable')
export class FormFieldDto extends FormFieldEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class FormFieldFindDto extends FormFieldEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${FormFieldEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class FormFieldFindInputWhereDto extends FormFieldDto implements FindInputWhereCRUDTypeDefinition{
...
@InputType()
export class FormFieldFindInputSortOrderDto implements FindOptionsOrder<FormFieldDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class FormFieldFindInputGroupByDto implements FindOptionsOrder<FormFieldDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class FormFieldFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<FormFieldDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [FormFieldFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<FormFieldFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => FormFieldFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: FormFieldFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => FormFieldFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<FormFieldFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class FormFieldFindOutputRowsDto extends FormFieldFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class FormFieldFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [FormFieldEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: FormFieldEntity | FormFieldEntity[] | any;
}
...
export class FormFieldFindOneByIdDto extends FormFieldEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${FormFieldEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class FormFieldFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class FormFieldCreateDto extends FormFieldEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${FormFieldEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class FormFieldCreateInputDto extends  FormFieldCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class FormFieldCreateOutputDto extends FormFieldFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class FormFieldUpdateDto extends FormFieldDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${FormFieldEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class FormFieldUpdateInputWhereDto extends FormFieldFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class FormFieldUpdateInputSetsDto extends PartialType(FormFieldCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class FormFieldUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [FormFieldUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<FormFieldUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => FormFieldUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: FormFieldUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class FormFieldUpdateOutputAffectedRowsDto extends FormFieldFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class FormFieldUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [FormFieldEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: FormFieldEntity[] | any; 
}
...
export class FormFieldSoftDeleteDto extends FormFieldEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${FormFieldEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class FormFieldSoftDeleteInputWhereDto extends FormFieldFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class FormFieldSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [FormFieldSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FormFieldSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FormFieldSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FormFieldDeleteDto extends FormFieldEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${FormFieldEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class FormFieldDeleteInputWhereDto extends FormFieldFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class FormFieldDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [FormFieldDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FormFieldDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FormFieldDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FormFieldRestoreDto extends FormFieldEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${FormFieldEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class FormFieldRestoreInputWhereDto extends FormFieldFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class FormFieldRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [FormFieldRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FormFieldRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FormFieldRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FormFieldUpsertDto extends FormFieldEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${FormFieldEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class FormFieldUpsertInputDto extends FormFieldCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof FormFieldUpsertInputDto)[] = ['title'];
}
...
@ObjectType()
@Directive('@shareable')
export class FormFieldUpsertOutputDto extends IntersectionType(FormFieldCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class FormFieldSoftRemoveDto extends FormFieldEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${FormFieldEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class FormFieldSoftRemoveInputWhereDto extends FormFieldFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class FormFieldSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [FormFieldSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FormFieldSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FormFieldSoftRemoveOutputAffectedRowsDto extends FormFieldFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class FormFieldSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FormFieldRemoveDto extends FormFieldEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${FormFieldEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class FormFieldRemoveInputWhereDto extends FormFieldFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class FormFieldRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [FormFieldRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FormFieldRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FormFieldRemoveOutputAffectedRowsDto extends FormFieldFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class FormFieldRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FormFieldRecoverDto extends FormFieldEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${FormFieldEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class FormFieldRecoverInputWhereDto extends FormFieldFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class FormFieldRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [FormFieldRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<FormFieldRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class FormFieldRecoverOutputAffectedRowsDto extends FormFieldFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class FormFieldRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class FormFieldUploadDto extends FormFieldEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${FormFieldEntity?.metaname}${UploadArtefact}`;
...
@Field(() => FormFieldUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: FormFieldUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class FormFieldUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class FormFieldUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class FormFieldUploadDeleteDto extends FormFieldEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${FormFieldEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class FormFieldUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class FormFieldUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
