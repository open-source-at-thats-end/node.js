...
import { AcademicDegreeEntityMeta as meta, AcademicDegreeEntity } from "../entities/degree.entity";
...
import { AcademicDegreeUploadFileFieldEnum } from "../degree.enum";
import { AcademicFieldFindInputWhereDto } from "../../field/dto/field.dto";
...
@Directive('@shareable')
export class AcademicDegreeDto extends AcademicDegreeEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class AcademicDegreeFindDto extends AcademicDegreeEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${AcademicDegreeEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class AcademicDegreeFindInputWhereDto extends AcademicDegreeDto implements FindInputWhereCRUDTypeDefinition{
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.id.desc})
    @IsOptional()
    declare id?: FindOperatorDto;

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.acadfield_id.desc})
    @IsOptional()
    declare acadfield_id?: FindOperatorDto;
    ...
    @Field(() => [AcademicFieldFindInputWhereDto], {nullable: true, description: meta?.fr_academic_field.desc})
    @IsOptional()
    declare fr_academic_field?: AcademicFieldFindInputWhereDto[];
  
}

@InputType()
export class AcademicDegreeFindInputSortOrderDto implements FindOptionsOrder<AcademicDegreeDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class AcademicDegreeFindInputGroupByDto implements FindOptionsOrder<AcademicDegreeDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class AcademicDegreeFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<AcademicDegreeDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [AcademicDegreeFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<AcademicDegreeFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => AcademicDegreeFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by})
    @IsOptional()
    declare groupBy?: AcademicDegreeFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => AcademicDegreeFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<AcademicDegreeFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeFindOutputRowsDto extends AcademicDegreeFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class AcademicDegreeFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [AcademicDegreeEntity], {description:CrudDefMetaDesc.find_rows})
    declare rows?: AcademicDegreeEntity | AcademicDegreeEntity[] | any;
}
...
export class AcademicDegreeFindOneByIdDto extends AcademicDegreeEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${AcademicDegreeEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class AcademicDegreeFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class AcademicDegreeCreateDto extends AcademicDegreeEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${AcademicDegreeEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class AcademicDegreeCreateInputDto extends  AcademicDegreeCreateDto implements CreateInputCRUDTypeDefinition {

    @Field(() => Int, {nullable: false, description: meta?.acadfield_id.desc})
    declare acadfield_id?: number;
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeCreateOutputDto extends AcademicDegreeFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class AcademicDegreeUpdateDto extends AcademicDegreeDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${AcademicDegreeEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class AcademicDegreeUpdateInputWhereDto extends AcademicDegreeFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class AcademicDegreeUpdateInputSetsDto extends PartialType(AcademicDegreeCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class AcademicDegreeUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [AcademicDegreeUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<AcademicDegreeUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => AcademicDegreeUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: AcademicDegreeUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeUpdateOutputAffectedRowsDto extends AcademicDegreeFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [AcademicDegreeEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: AcademicDegreeEntity[] | any; 
}
...
export class AcademicDegreeSoftDeleteDto extends AcademicDegreeEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${AcademicDegreeEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class AcademicDegreeSoftDeleteInputWhereDto extends AcademicDegreeFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class AcademicDegreeSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [AcademicDegreeSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<AcademicDegreeSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class AcademicDegreeDeleteDto extends AcademicDegreeEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${AcademicDegreeEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class AcademicDegreeDeleteInputWhereDto extends AcademicDegreeFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class AcademicDegreeDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [AcademicDegreeDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<AcademicDegreeDeleteInputWhereDto>[];
}

// ████ DELETE OUTPUT DTO ████████████████████████████████████████████████
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class AcademicDegreeRestoreDto extends AcademicDegreeEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${AcademicDegreeEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class AcademicDegreeRestoreInputWhereDto extends AcademicDegreeFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class AcademicDegreeRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [AcademicDegreeRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<AcademicDegreeRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class AcademicDegreeUpsertDto extends AcademicDegreeEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${AcademicDegreeEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class AcademicDegreeUpsertInputDto extends AcademicDegreeCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof AcademicDegreeUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeUpsertOutputDto extends IntersectionType(AcademicDegreeCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class AcademicDegreeSoftRemoveDto extends AcademicDegreeEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${AcademicDegreeEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class AcademicDegreeSoftRemoveInputWhereDto extends AcademicDegreeFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class AcademicDegreeSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [AcademicDegreeSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<AcademicDegreeSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeSoftRemoveOutputAffectedRowsDto extends AcademicDegreeFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class AcademicDegreeRemoveDto extends AcademicDegreeEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${AcademicDegreeEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class AcademicDegreeRemoveInputWhereDto extends AcademicDegreeFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class AcademicDegreeRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [AcademicDegreeRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<AcademicDegreeRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeRemoveOutputAffectedRowsDto extends AcademicDegreeFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class AcademicDegreeRecoverDto extends AcademicDegreeEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${AcademicDegreeEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class AcademicDegreeRecoverInputWhereDto extends AcademicDegreeFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class AcademicDegreeRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [AcademicDegreeRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<AcademicDegreeRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeRecoverOutputAffectedRowsDto extends AcademicDegreeFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class AcademicDegreeUploadDto extends AcademicDegreeEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${AcademicDegreeEntity?.metaname}${UploadArtefact}`;
...
@Field(() => AcademicDegreeUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: AcademicDegreeUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class AcademicDegreeUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class AcademicDegreeUploadDeleteDto extends AcademicDegreeEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${AcademicDegreeEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class AcademicDegreeUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class AcademicDegreeUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
