...
import { StaticDataEntityMeta as meta, StaticDataEntity } from "../entities/static.data.entity";
...
import { StaticDataUploadFileFieldEnum } from "../static.data.enum";
...
import { StaticDataValueFindInputWhereDto } from "../value/dto/value.dto";
...
/**
 * # [done] ['../entities/static.data.entity', './dto/static.data.dto'] . Hint: find [ /static.data. => and replace with ] [ /your-module. ] 
 * # [done] do not break some dependences which required this class
 * # [done] module [StaticData]
...
@Directive('@shareable')
export class StaticDataDto extends StaticDataEntity implements FindInputDtoCRUDTypeDefinition{
     /**
    ...
    declare desc?: any;
    declare table?: any;
    declare table_field_for_key?: any;
    declare table_field_for_value?: any;
    declare table_field_for_deleted?: any;
    declare created?: any;
    declare updated?: any; 
    declare deleted?: any;
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class StaticDataFindDto extends StaticDataEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${StaticDataEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class StaticDataFindInputWhereDto extends StaticDataDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.table.desc})
    @IsOptional()
    declare table?: FindOperatorDto;

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.table_field_for_key.desc})
    @IsOptional()
    declare table_field_for_key?: FindOperatorDto;
...
@InputType()
export class StaticDataFindInputSortOrderDto implements FindOptionsOrder<StaticDataDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class StaticDataFindInputGroupByDto implements FindOptionsOrder<StaticDataDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class StaticDataFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<StaticDataDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [StaticDataFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<StaticDataFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => StaticDataFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: StaticDataFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => StaticDataFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<StaticDataFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataFindOutputRowsDto extends StaticDataFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class StaticDataFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [StaticDataEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: StaticDataEntity | StaticDataEntity[] | any;
}
...
export class StaticDataFindOneByIdDto extends StaticDataEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${StaticDataEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class StaticDataFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class StaticDataCreateDto extends StaticDataEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${StaticDataEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class StaticDataCreateInputDto extends  StaticDataCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class StaticDataCreateOutputDto extends StaticDataFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class StaticDataUpdateDto extends StaticDataDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${StaticDataEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class StaticDataUpdateInputWhereDto extends StaticDataFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class StaticDataUpdateInputSetsDto extends PartialType(StaticDataCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class StaticDataUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [StaticDataUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<StaticDataUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => StaticDataUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: StaticDataUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class StaticDataUpdateOutputAffectedRowsDto extends StaticDataFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StaticDataUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [StaticDataEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: StaticDataEntity[] | any; 
}
...
export class StaticDataSoftDeleteDto extends StaticDataEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class StaticDataSoftDeleteInputWhereDto extends StaticDataFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class StaticDataSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [StaticDataSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataDeleteDto extends StaticDataEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class StaticDataDeleteInputWhereDto extends StaticDataFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class StaticDataDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [StaticDataDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataRestoreDto extends StaticDataEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${StaticDataEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class StaticDataRestoreInputWhereDto extends StaticDataFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class StaticDataRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [StaticDataRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataUpsertDto extends StaticDataEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class StaticDataUpsertInputDto extends StaticDataCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof StaticDataUpsertInputDto)[] = ['name'];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataUpsertOutputDto extends IntersectionType(StaticDataCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class StaticDataSoftRemoveDto extends StaticDataEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class StaticDataSoftRemoveInputWhereDto extends StaticDataFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class StaticDataSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [StaticDataSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataSoftRemoveOutputAffectedRowsDto extends StaticDataFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StaticDataSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataRemoveDto extends StaticDataEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class StaticDataRemoveInputWhereDto extends StaticDataFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class StaticDataRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [StaticDataRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataRemoveOutputAffectedRowsDto extends StaticDataFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StaticDataRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataRecoverDto extends StaticDataEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class StaticDataRecoverInputWhereDto extends StaticDataFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class StaticDataRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [StaticDataRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataRecoverOutputAffectedRowsDto extends StaticDataFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StaticDataRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataUploadDto extends StaticDataEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${StaticDataEntity?.metaname}${UploadArtefact}`;
...
@Field(() => StaticDataUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: StaticDataUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class StaticDataUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class StaticDataUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class StaticDataUploadDeleteDto extends StaticDataEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${StaticDataEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class StaticDataUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class StaticDataUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
...
/**
 * █████████████████████████████████████████████████████████████
 * █ STATIC DATA JSON DTO ██████████████████████████████████████
 * █████████████████████████████████████████████████████████████
**/

export class StaticDataJsonDto extends StaticDataEntity {
  static metaname: string = `${StaticDataEntity?.metaname}Json`;
  static metadesc: string = `Static data json object used in various settings.`;
}


/**
 * █████████████████████████████████████████████████████████████
 * █ STATIC DATA JSON FROM LOCAL STORAGE DTO ███████████████████
 * █████████████████████████████████████████████████████████████
**/

export class StaticDataJsonFromLocalStorageDto extends StaticDataEntity {
  static metaname: string = `${StaticDataEntity?.metaname}JsonFromLocalStorage`;
  static metadesc: string = `Static data json object used in various settings from local storage.`;
}
