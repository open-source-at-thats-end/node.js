...
import { StaticDataValueEntityMeta as meta, StaticDataValueEntity } from "../entities/value.entity";
...
import { StaticDataValueUploadFileFieldEnum } from "../value.enum";
import { StaticDataFindInputWhereDto } from "../../dto/static.data.dto";
...
/**
 * # [done] ['../entities/static.data.value.entity', './dto/static.data.value.dto'] . Hint: find [ /static.data.value. => and replace with ] [ /your-module. ] 
 * # [done] do not break some dependences which required this class
 * # [done] module [StaticDataValue]
...
@Directive('@shareable')
export class StaticDataValueDto extends StaticDataValueEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class StaticDataValueFindDto extends StaticDataValueEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${StaticDataValueEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class StaticDataValueFindInputWhereDto extends StaticDataValueDto implements FindInputWhereCRUDTypeDefinition{
...
@InputType()
export class StaticDataValueFindInputSortOrderDto implements FindOptionsOrder<StaticDataValueDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class StaticDataValueFindInputGroupByDto implements FindOptionsOrder<StaticDataValueDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class StaticDataValueFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<StaticDataValueDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [StaticDataValueFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<StaticDataValueFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => StaticDataValueFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: StaticDataValueFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => StaticDataValueFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<StaticDataValueFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueFindOutputRowsDto extends StaticDataValueFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class StaticDataValueFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [StaticDataValueEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: StaticDataValueEntity | StaticDataValueEntity[] | any;
}
...
export class StaticDataValueFindOneByIdDto extends StaticDataValueEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${StaticDataValueEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class StaticDataValueFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class StaticDataValueCreateDto extends StaticDataValueEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${StaticDataValueEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class StaticDataValueCreateInputDto extends  StaticDataValueCreateDto implements CreateInputCRUDTypeDefinition {
  
    @Field(() => String, {nullable: false, description: meta?.key.desc})
    declare key?: string;

    @Field(() => String, {nullable: false, description: meta?.value.desc})
    declare value?: string;

    @Field(() => Int, {nullable: false, description: meta?.sd_id.desc})
    declare sd_id?: number;

    @Field(() => String, {nullable: false, description: meta?.sd_name.desc})
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueCreateOutputDto extends StaticDataValueFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class StaticDataValueUpdateDto extends StaticDataValueDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${StaticDataValueEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class StaticDataValueUpdateInputWhereDto extends StaticDataValueFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class StaticDataValueUpdateInputSetsDto extends PartialType(StaticDataValueCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class StaticDataValueUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [StaticDataValueUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<StaticDataValueUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => StaticDataValueUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: StaticDataValueUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueUpdateOutputAffectedRowsDto extends StaticDataValueFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [StaticDataValueEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: StaticDataValueEntity[] | any; 
}
...
export class StaticDataValueSoftDeleteDto extends StaticDataValueEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataValueEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class StaticDataValueSoftDeleteInputWhereDto extends StaticDataValueFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class StaticDataValueSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [StaticDataValueSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataValueSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataValueDeleteDto extends StaticDataValueEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataValueEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class StaticDataValueDeleteInputWhereDto extends StaticDataValueFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class StaticDataValueDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [StaticDataValueDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataValueDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataValueRestoreDto extends StaticDataValueEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${StaticDataValueEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class StaticDataValueRestoreInputWhereDto extends StaticDataValueFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class StaticDataValueRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [StaticDataValueRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataValueRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataValueUpsertDto extends StaticDataValueEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataValueEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class StaticDataValueUpsertInputDto extends StaticDataValueCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof StaticDataValueUpsertInputDto)[] = ['sd_id', 'key'];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueUpsertOutputDto extends IntersectionType(StaticDataValueCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class StaticDataValueSoftRemoveDto extends StaticDataValueEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataValueEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class StaticDataValueSoftRemoveInputWhereDto extends StaticDataValueFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class StaticDataValueSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [StaticDataValueSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataValueSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueSoftRemoveOutputAffectedRowsDto extends StaticDataValueFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataValueRemoveDto extends StaticDataValueEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataValueEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class StaticDataValueRemoveInputWhereDto extends StaticDataValueFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class StaticDataValueRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [StaticDataValueRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataValueRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueRemoveOutputAffectedRowsDto extends StaticDataValueFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataValueRecoverDto extends StaticDataValueEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${StaticDataValueEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class StaticDataValueRecoverInputWhereDto extends StaticDataValueFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class StaticDataValueRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [StaticDataValueRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StaticDataValueRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueRecoverOutputAffectedRowsDto extends StaticDataValueFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StaticDataValueUploadDto extends StaticDataValueEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${StaticDataValueEntity?.metaname}${UploadArtefact}`;
...
@Field(() => StaticDataValueUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: StaticDataValueUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class StaticDataValueUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class StaticDataValueUploadDeleteDto extends StaticDataValueEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${StaticDataValueEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class StaticDataValueUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class StaticDataValueUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
