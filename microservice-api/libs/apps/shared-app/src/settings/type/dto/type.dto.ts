...
import { SettingTypeEntityMeta as meta, SettingTypeEntity } from "../entities/type.entity";
...
import { SettingTypeUploadFileFieldEnum } from "../type.enum";
...
/**
 * # [done] ['../entities/setting.type.entity', './dto/setting.type.dto'] . Hint: find [ /setting.type. => and replace with ] [ /your-module. ] 
 * # [done] do not break some dependences which required this class
 * # [done] module [SettingType]
...
@Directive('@shareable')
export class SettingTypeDto extends SettingTypeEntity implements FindInputDtoCRUDTypeDefinition{
     /**
     ...
     **/
      declare id?: any;
      declare title?: any;
      declare for_table?: any;
      declare for_table_field?: any;
      declare created?: any;
      declare updated?: any;
      declare deleted?: any;
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class SettingTypeFindDto extends SettingTypeEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${SettingTypeEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class SettingTypeFindInputWhereDto extends SettingTypeDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.for_table.desc})
    @IsOptional()
    declare for_table?: FindOperatorDto;

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.for_table_field.desc})
    @IsOptional()
    declare for_table_field?: FindOperatorDto;
...
@InputType()
export class SettingTypeFindInputSortOrderDto implements FindOptionsOrder<SettingTypeDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class SettingTypeFindInputGroupByDto implements FindOptionsOrder<SettingTypeDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class SettingTypeFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<SettingTypeDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [SettingTypeFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<SettingTypeFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => SettingTypeFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: SettingTypeFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => SettingTypeFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<SettingTypeFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeFindOutputRowsDto extends SettingTypeFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class SettingTypeFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [SettingTypeEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: SettingTypeEntity | SettingTypeEntity[] | any;
}
...
export class SettingTypeFindOneByIdDto extends SettingTypeEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${SettingTypeEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class SettingTypeFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class SettingTypeCreateDto extends SettingTypeEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${SettingTypeEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class SettingTypeCreateInputDto extends  SettingTypeCreateDto implements CreateInputCRUDTypeDefinition {
  
    @Field(() => String, {nullable: false, description: meta?.title.desc})
    declare title?: string;

    @Field(() => String, {nullable: true, description: meta?.for_table.desc})
    declare for_table?: string; 

    @Field(() => String, {nullable: true, description: meta?.for_table_field.desc}) 
    declare for_table_field?: string;
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeCreateOutputDto extends SettingTypeFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class SettingTypeUpdateDto extends SettingTypeDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${SettingTypeEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class SettingTypeUpdateInputWhereDto extends SettingTypeFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class SettingTypeUpdateInputSetsDto extends PartialType(SettingTypeCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class SettingTypeUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [SettingTypeUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<SettingTypeUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => SettingTypeUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: SettingTypeUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeUpdateOutputAffectedRowsDto extends SettingTypeFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [SettingTypeEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: SettingTypeEntity[] | any; 
}
...
export class SettingTypeSoftDeleteDto extends SettingTypeEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${SettingTypeEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class SettingTypeSoftDeleteInputWhereDto extends SettingTypeFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class SettingTypeSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [SettingTypeSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingTypeSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingTypeDeleteDto extends SettingTypeEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${SettingTypeEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class SettingTypeDeleteInputWhereDto extends SettingTypeFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class SettingTypeDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [SettingTypeDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingTypeDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingTypeRestoreDto extends SettingTypeEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${SettingTypeEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class SettingTypeRestoreInputWhereDto extends SettingTypeFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class SettingTypeRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [SettingTypeRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingTypeRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingTypeUpsertDto extends SettingTypeEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${SettingTypeEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class SettingTypeUpsertInputDto extends SettingTypeCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof SettingTypeUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeUpsertOutputDto extends IntersectionType(SettingTypeCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class SettingTypeSoftRemoveDto extends SettingTypeEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${SettingTypeEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class SettingTypeSoftRemoveInputWhereDto extends SettingTypeFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class SettingTypeSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [SettingTypeSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingTypeSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeSoftRemoveOutputAffectedRowsDto extends SettingTypeFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingTypeRemoveDto extends SettingTypeEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${SettingTypeEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class SettingTypeRemoveInputWhereDto extends SettingTypeFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class SettingTypeRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [SettingTypeRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingTypeRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeRemoveOutputAffectedRowsDto extends SettingTypeFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingTypeRecoverDto extends SettingTypeEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${SettingTypeEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class SettingTypeRecoverInputWhereDto extends SettingTypeFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class SettingTypeRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [SettingTypeRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingTypeRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeRecoverOutputAffectedRowsDto extends SettingTypeFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingTypeUploadDto extends SettingTypeEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${SettingTypeEntity?.metaname}${UploadArtefact}`;
...
@Field(() => SettingTypeUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: SettingTypeUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class SettingTypeUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class SettingTypeUploadDeleteDto extends SettingTypeEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${SettingTypeEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class SettingTypeUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class SettingTypeUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
