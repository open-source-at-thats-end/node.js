...
import { SettingCategoryEntityMeta as meta, SettingCategoryEntity } from "../entities/category.entity";
...
import { SettingCategoryUploadFileFieldEnum } from "../category.enum";
...
/**
 * # [done] ['../entities/setting.category.entity', './dto/setting.category.dto'] . Hint: find [ /setting.category. => and replace with ] [ /your-module. ] 
 * # [done] do not break some dependences which required this class
 * # [done] module [SettingCategory]
...
@Directive('@shareable')
export class SettingCategoryDto extends SettingCategoryEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class SettingCategoryFindDto extends SettingCategoryEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${SettingCategoryEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class SettingCategoryFindInputWhereDto extends SettingCategoryDto implements FindInputWhereCRUDTypeDefinition{
...
@InputType()
export class SettingCategoryFindInputSortOrderDto implements FindOptionsOrder<SettingCategoryDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class SettingCategoryFindInputGroupByDto implements FindOptionsOrder<SettingCategoryDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class SettingCategoryFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<SettingCategoryDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [SettingCategoryFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<SettingCategoryFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => SettingCategoryFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: SettingCategoryFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => SettingCategoryFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<SettingCategoryFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryFindOutputRowsDto extends SettingCategoryFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class SettingCategoryFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [SettingCategoryEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: SettingCategoryEntity | SettingCategoryEntity[] | any;
}
...
export class SettingCategoryFindOneByIdDto extends SettingCategoryEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${SettingCategoryEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class SettingCategoryFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class SettingCategoryCreateDto extends SettingCategoryEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${SettingCategoryEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class SettingCategoryCreateInputDto extends  SettingCategoryCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryCreateOutputDto extends SettingCategoryFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class SettingCategoryUpdateDto extends SettingCategoryDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${SettingCategoryEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class SettingCategoryUpdateInputWhereDto extends SettingCategoryFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class SettingCategoryUpdateInputSetsDto extends PartialType(SettingCategoryCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class SettingCategoryUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [SettingCategoryUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<SettingCategoryUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => SettingCategoryUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: SettingCategoryUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryUpdateOutputAffectedRowsDto extends SettingCategoryFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [SettingCategoryEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: SettingCategoryEntity[] | any; 
}
...
export class SettingCategorySoftDeleteDto extends SettingCategoryEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${SettingCategoryEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class SettingCategorySoftDeleteInputWhereDto extends SettingCategoryFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class SettingCategorySoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [SettingCategorySoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingCategorySoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingCategorySoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingCategoryDeleteDto extends SettingCategoryEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${SettingCategoryEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class SettingCategoryDeleteInputWhereDto extends SettingCategoryFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class SettingCategoryDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [SettingCategoryDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingCategoryDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingCategoryRestoreDto extends SettingCategoryEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${SettingCategoryEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class SettingCategoryRestoreInputWhereDto extends SettingCategoryFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class SettingCategoryRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [SettingCategoryRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingCategoryRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingCategoryUpsertDto extends SettingCategoryEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${SettingCategoryEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class SettingCategoryUpsertInputDto extends SettingCategoryCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof SettingCategoryUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryUpsertOutputDto extends IntersectionType(SettingCategoryCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class SettingCategorySoftRemoveDto extends SettingCategoryEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${SettingCategoryEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class SettingCategorySoftRemoveInputWhereDto extends SettingCategoryFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class SettingCategorySoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [SettingCategorySoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingCategorySoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingCategorySoftRemoveOutputAffectedRowsDto extends SettingCategoryFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SettingCategorySoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingCategoryRemoveDto extends SettingCategoryEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${SettingCategoryEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class SettingCategoryRemoveInputWhereDto extends SettingCategoryFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class SettingCategoryRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [SettingCategoryRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingCategoryRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryRemoveOutputAffectedRowsDto extends SettingCategoryFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingCategoryRecoverDto extends SettingCategoryEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${SettingCategoryEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class SettingCategoryRecoverInputWhereDto extends SettingCategoryFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class SettingCategoryRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [SettingCategoryRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SettingCategoryRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryRecoverOutputAffectedRowsDto extends SettingCategoryFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SettingCategoryUploadDto extends SettingCategoryEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${SettingCategoryEntity?.metaname}${UploadArtefact}`;
...
@Field(() => SettingCategoryUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: SettingCategoryUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class SettingCategoryUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class SettingCategoryUploadDeleteDto extends SettingCategoryEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${SettingCategoryEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class SettingCategoryUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class SettingCategoryUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
