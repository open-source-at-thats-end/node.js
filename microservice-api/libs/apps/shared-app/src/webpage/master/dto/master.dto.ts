...
import { WebPageMasterEntityMeta as meta, WebPageMasterEntity } from "../entities/master.entity";
...
import { WebPageMasterUploadFileFieldEnum, positionEnum, pgTypeEnum } from "../master.enum";
import { WebPageHierarchyFindInputWhereDto } from "../../hierarchy/dto/hierarchy.dto";
...
@Directive('@shareable')
export class WebPageMasterDto extends WebPageMasterEntity implements FindInputDtoCRUDTypeDefinition{
     /**
     ...
     **/
     ...
     declare type?: any;
     declare content?: any;
     declare browser_title?: any;
     declare meta_keyword?: any;
     declare meta_desc?: any;
     declare active?: any; 
     declare created?: any;
     declare updated?: any;
     declare deleted?: any;

     declare fr_parent_page?: any;
     declare fr_child_page?: any;
}
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class WebPageMasterFindDto extends WebPageMasterEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${WebPageMasterEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class WebPageMasterFindInputWhereDto extends WebPageMasterDto implements FindInputWhereCRUDTypeDefinition{
  ...
  @Field(() => FindOperatorDto, {nullable: true, description: meta?.position.desc})
  @IsOptional()
  declare position?: FindOperatorDto;

  @Field(() => FindOperatorDto, {nullable: true, description: meta?.type.desc})
  @IsOptional()
  declare type?: FindOperatorDto;
  ...
  declare deleted?: FindOperatorDto; 
    ...
    @Field(() => [WebPageHierarchyFindInputWhereDto], {nullable: true, description: meta?.fr_parent_page.desc})
    @IsOptional()
    declare fr_parent_page?: WebPageHierarchyFindInputWhereDto[];

    @Field(() => [WebPageHierarchyFindInputWhereDto], {nullable: true, description: meta?.fr_child_page.desc})
    @IsOptional()
    declare fr_child_page?: WebPageHierarchyFindInputWhereDto[];
    
}

@InputType()
export class WebPageMasterFindInputSortOrderDto implements FindOptionsOrder<WebPageMasterDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class WebPageMasterFindInputGroupByDto implements FindOptionsOrder<WebPageMasterDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class WebPageMasterFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<WebPageMasterDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [WebPageMasterFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<WebPageMasterFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => WebPageMasterFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: WebPageMasterFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => WebPageMasterFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<WebPageMasterFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterFindOutputRowsDto extends WebPageMasterFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class WebPageMasterFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [WebPageMasterEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: WebPageMasterEntity | WebPageMasterEntity[] | any;
}
...
export class WebPageMasterFindOneByIdDto extends WebPageMasterEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${WebPageMasterEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class WebPageMasterFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class WebPageMasterCreateDto extends WebPageMasterEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${WebPageMasterEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class WebPageMasterCreateInputDto extends  WebPageMasterCreateDto implements CreateInputCRUDTypeDefinition {
  ...
  @Field(() => positionEnum, {nullable: false, description: meta?.position.desc})
  declare position: number;
  
  @Field(() => pgTypeEnum, {nullable: true, description: meta?.type.desc})
  declare type?: string;

  @Field(() => String, {nullable: false, description: meta?.content.desc})
  declare content: string; 

  @Field(() => String, {nullable: false, description: meta?.browser_title.desc})
  declare browser_title: string;  

  @Field(() => String, {nullable: false, description: meta?.meta_keyword.desc}) 
  declare meta_keyword: string;

  @Field(() => String, {nullable: false, description: meta?.meta_desc.desc})
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterCreateOutputDto extends WebPageMasterFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class WebPageMasterUpdateDto extends WebPageMasterDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${WebPageMasterEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class WebPageMasterUpdateInputWhereDto extends WebPageMasterFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class WebPageMasterUpdateInputSetsDto extends PartialType(WebPageMasterCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class WebPageMasterUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [WebPageMasterUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<WebPageMasterUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => WebPageMasterUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: WebPageMasterUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterUpdateOutputAffectedRowsDto extends WebPageMasterFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [WebPageMasterEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: WebPageMasterEntity[] | any; 
}
...
export class WebPageMasterSoftDeleteDto extends WebPageMasterEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${WebPageMasterEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class WebPageMasterSoftDeleteInputWhereDto extends WebPageMasterFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class WebPageMasterSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [WebPageMasterSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<WebPageMasterSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class WebPageMasterDeleteDto extends WebPageMasterEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${WebPageMasterEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class WebPageMasterDeleteInputWhereDto extends WebPageMasterFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class WebPageMasterDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [WebPageMasterDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<WebPageMasterDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class WebPageMasterRestoreDto extends WebPageMasterEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${WebPageMasterEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class WebPageMasterRestoreInputWhereDto extends WebPageMasterFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class WebPageMasterRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [WebPageMasterRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<WebPageMasterRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class WebPageMasterUpsertDto extends WebPageMasterEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${WebPageMasterEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class WebPageMasterUpsertInputDto extends WebPageMasterCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof WebPageMasterUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterUpsertOutputDto extends IntersectionType(WebPageMasterCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class WebPageMasterSoftRemoveDto extends WebPageMasterEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${WebPageMasterEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class WebPageMasterSoftRemoveInputWhereDto extends WebPageMasterFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class WebPageMasterSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [WebPageMasterSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<WebPageMasterSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterSoftRemoveOutputAffectedRowsDto extends WebPageMasterFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class WebPageMasterRemoveDto extends WebPageMasterEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${WebPageMasterEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class WebPageMasterRemoveInputWhereDto extends WebPageMasterFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class WebPageMasterRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [WebPageMasterRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<WebPageMasterRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterRemoveOutputAffectedRowsDto extends WebPageMasterFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class WebPageMasterRecoverDto extends WebPageMasterEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${WebPageMasterEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class WebPageMasterRecoverInputWhereDto extends WebPageMasterFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class WebPageMasterRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [WebPageMasterRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<WebPageMasterRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterRecoverOutputAffectedRowsDto extends WebPageMasterFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class WebPageMasterUploadDto extends WebPageMasterEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${WebPageMasterEntity?.metaname}${UploadArtefact}`;
...
@Field(() => WebPageMasterUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: WebPageMasterUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class WebPageMasterUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class WebPageMasterUploadDeleteDto extends WebPageMasterEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${WebPageMasterEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class WebPageMasterUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class WebPageMasterUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
