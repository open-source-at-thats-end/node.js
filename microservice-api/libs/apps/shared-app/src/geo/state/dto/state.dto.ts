...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class StateFindDto extends StateEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${StateEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class StateFindInputWhereDto extends StateDto implements FindInputWhereCRUDTypeDefinition{
...
@InputType()
export class StateFindInputSortOrderDto implements FindOptionsOrder<StateDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class StateFindInputGroupByDto implements FindOptionsOrder<StateDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class StateFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<StateDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [StateFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<StateFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => StateFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: StateFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => StateFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<StateFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class StateFindOutputRowsDto extends StateFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class StateFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [StateEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: StateEntity | StateEntity[] | any;
}
...
export class StateFindOneByIdDto extends StateEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${StateEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class StateFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class StateCreateDto extends StateEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${StateEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class StateCreateInputDto extends  StateCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class StateCreateOutputDto extends StateFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class StateUpdateDto extends StateDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${StateEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class StateUpdateInputWhereDto extends StateFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class StateUpdateInputSetsDto extends PartialType(StateCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class StateUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [StateUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<StateUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => StateUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: StateUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class StateUpdateOutputAffectedRowsDto extends StateFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StateUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [StateEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: StateEntity[] | any;
}
...
export class StateSoftDeleteDto extends StateEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${StateEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class StateSoftDeleteInputWhereDto extends StateFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class StateSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [StateSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StateSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StateSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StateDeleteDto extends StateEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${StateEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class StateDeleteInputWhereDto extends StateFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class StateDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [StateDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StateDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StateDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StateRestoreDto extends StateEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${StateEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class StateRestoreInputWhereDto extends StateFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class StateRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [StateRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StateRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StateRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StateUpsertDto extends StateEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${StateEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class StateUpsertInputDto extends StateCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof StateUpsertInputDto)[] = ['country_id', 'name','type'];
}
...
@ObjectType()
@Directive('@shareable')
export class StateUpsertOutputDto extends IntersectionType(StateCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class StateSoftRemoveDto extends StateEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${StateEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class StateSoftRemoveInputWhereDto extends StateFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class StateSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [StateSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StateSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StateSoftRemoveOutputAffectedRowsDto extends StateFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StateSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [StateEntity]) 
  declare affectedRows?: StateEntity[]
}
...
export class StateRemoveDto extends StateEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${StateEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class StateRemoveInputWhereDto extends StateFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class StateRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [StateRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StateRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StateRemoveOutputAffectedRowsDto extends StateFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StateRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StateRecoverDto extends StateEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${StateEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class StateRecoverInputWhereDto extends StateFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class StateRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [StateRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<StateRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class StateRecoverOutputAffectedRowsDto extends StateFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class StateRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class StateUploadDto extends StateEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${StateEntity?.metaname}${UploadArtefact}`;
...
@Field(() => StateUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: StateUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class StateUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class StateUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class StateUploadDeleteDto extends StateEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${StateEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class StateUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class StateUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
