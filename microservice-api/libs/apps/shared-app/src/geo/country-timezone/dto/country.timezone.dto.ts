...
import { CountryTimezoneEntityMeta as meta, CountryTimezoneEntity } from "../entities/country.timezone.entity";
...
import { CountryTimezoneUploadFileFieldEnum } from "../country.timezone.enum";
...
@Directive('@shareable')
export class CountryTimezoneDto extends CountryTimezoneEntity implements FindInputDtoCRUDTypeDefinition{
    /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class CountryTimezoneFindDto extends CountryTimezoneEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${CountryTimezoneEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class CountryTimezoneFindInputWhereDto extends CountryTimezoneDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.tz_id.desc})
    @IsOptional()
    declare tz_id?: FindOperatorDto;
    ...
    @Field(() => [TimezoneFindInputWhereDto], {nullable: true, description: meta?.fr_timezone.desc})
    @IsOptional()
    declare fr_timezone?: TimezoneFindInputWhereDto[];

}

@InputType()
export class CountryTimezoneFindInputSortOrderDto implements FindOptionsOrder<CountryTimezoneDto>, FindInputSortOrderCRUDTypeDefinition{
    ...
    @Field(() => RecordSortDirectionEnum, {nullable: true, description: meta?.tz_id.desc})
    @IsOptional()
...
@InputType()
export class CountryTimezoneFindInputGroupByDto implements FindOptionsOrder<CountryTimezoneDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class CountryTimezoneFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<CountryTimezoneDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [CountryTimezoneFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<CountryTimezoneFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => CountryTimezoneFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by})
    @IsOptional()
    declare groupBy?: CountryTimezoneFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => CountryTimezoneFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<CountryTimezoneFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneFindOutputRowsDto extends CountryTimezoneFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class CountryTimezoneFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [CountryTimezoneEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: CountryTimezoneEntity[] | any;
}
...
export class CountryTimezoneFindOneByIdDto extends CountryTimezoneEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${CountryTimezoneEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class CountryTimezoneFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class CountryTimezoneCreateDto extends CountryTimezoneEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${CountryTimezoneEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class CountryTimezoneCreateInputDto extends  CountryTimezoneCreateDto implements CreateInputCRUDTypeDefinition {
  
    @Field(() => Int, {nullable: false, description: meta?.country_id.desc})
    declare country_id: number;

    @Field(() => Int, {nullable: false, description: meta?.tz_id.desc})
    declare tz_id: number;
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneCreateOutputDto extends CountryTimezoneFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class CountryTimezoneUpdateDto extends CountryTimezoneDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${CountryTimezoneEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class CountryTimezoneUpdateInputWhereDto extends CountryTimezoneFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class CountryTimezoneUpdateInputSetsDto extends PartialType(CountryTimezoneCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class CountryTimezoneUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [CountryTimezoneUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<CountryTimezoneUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => CountryTimezoneUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets})
    @IsNotEmpty()
    sets!: CountryTimezoneUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneUpdateOutputAffectedRowsDto extends CountryTimezoneFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [CountryTimezoneEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: CountryTimezoneEntity[] | any;
}
...
export class CountryTimezoneSoftDeleteDto extends CountryTimezoneEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${CountryTimezoneEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class CountryTimezoneSoftDeleteInputWhereDto extends CountryTimezoneFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class CountryTimezoneSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [CountryTimezoneSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CountryTimezoneSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CountryTimezoneDeleteDto extends CountryTimezoneEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${CountryTimezoneEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class CountryTimezoneDeleteInputWhereDto extends CountryTimezoneFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class CountryTimezoneDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [CountryTimezoneDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CountryTimezoneDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CountryTimezoneRestoreDto extends CountryTimezoneEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${CountryTimezoneEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class CountryTimezoneRestoreInputWhereDto extends CountryTimezoneFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class CountryTimezoneRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [CountryTimezoneRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CountryTimezoneRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CountryTimezoneUpsertDto extends CountryTimezoneEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${CountryTimezoneEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class CountryTimezoneUpsertInputDto extends CountryTimezoneCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof CountryTimezoneUpsertInputDto)[] = ['country_id', 'tz_id'];
}
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneUpsertOutputDto extends IntersectionType(CountryTimezoneCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class CountryTimezoneSoftRemoveDto extends CountryTimezoneEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${CountryTimezoneEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class CountryTimezoneSoftRemoveInputWhereDto extends CountryTimezoneFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class CountryTimezoneSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [CountryTimezoneSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CountryTimezoneSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneSoftRemoveOutputAffectedRowsDto extends CountryTimezoneFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [CountryTimezoneEntity]) 
  declare affectedRows?: CountryTimezoneEntity[]
}
...
export class CountryTimezoneRemoveDto extends CountryTimezoneEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${CountryTimezoneEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class CountryTimezoneRemoveInputWhereDto extends CountryTimezoneFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class CountryTimezoneRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [CountryTimezoneRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where })
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CountryTimezoneRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneRemoveOutputAffectedRowsDto extends CountryTimezoneFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CountryTimezoneRecoverDto extends CountryTimezoneEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${CountryTimezoneEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class CountryTimezoneRecoverInputWhereDto extends CountryTimezoneFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class CountryTimezoneRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [CountryTimezoneRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CountryTimezoneRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneRecoverOutputAffectedRowsDto extends CountryTimezoneFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CountryTimezoneUploadDto extends CountryTimezoneEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${CountryTimezoneEntity?.metaname}${UploadArtefact}`;
...
@Field(() => CountryTimezoneUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: CountryTimezoneUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class CountryTimezoneUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class CountryTimezoneUploadDeleteDto extends CountryTimezoneEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${CountryTimezoneEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class CountryTimezoneUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class CountryTimezoneUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
