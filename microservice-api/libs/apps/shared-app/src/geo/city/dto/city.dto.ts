...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class CityFindDto extends CityEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${CityEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class CityFindInputWhereDto extends CityDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => [NewsLetterTrackLogFindInputWhereDto], {nullable: true, description: meta?.fr_newsletter_tracking_log_infos.desc})
    @IsOptional()
    declare fr_newsletter_tracking_log_infos?: NewsLetterTrackLogFindInputWhereDto[];

}

@InputType()
export class CityFindInputSortOrderDto implements FindOptionsOrder<CityDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class CityFindInputGroupByDto implements FindOptionsOrder<CityDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class CityFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<CityDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [CityFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<CityFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => CityFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by})
    @IsOptional()
    declare groupBy?: CityFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => CityFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<CityFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class CityFindOutputRowsDto extends CityFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class CityFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [CityEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: CityEntity[] | any;
}
...
export class CityFindOneByIdDto extends CityEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${CityEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class CityFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class CityCreateDto extends CityEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${CityEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class CityCreateInputDto extends  CityCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class CityCreateOutputDto extends CityFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class CityUpdateDto extends CityDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${CityEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class CityUpdateInputWhereDto extends CityFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class CityUpdateInputSetsDto extends PartialType(CityCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class CityUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [CityUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<CityUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => CityUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets})
    @IsNotEmpty()
    sets!: CityUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class CityUpdateOutputAffectedRowsDto extends CityFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CityUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [CityEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: CityEntity[] | any;
}
...
export class CitySoftDeleteDto extends CityEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${CityEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class CitySoftDeleteInputWhereDto extends CityFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class CitySoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [CitySoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CitySoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CitySoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CityDeleteDto extends CityEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${CityEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class CityDeleteInputWhereDto extends CityFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class CityDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [CityDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CityDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CityDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CityRestoreDto extends CityEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${CityEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class CityRestoreInputWhereDto extends CityFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class CityRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [CityRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CityRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CityRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CityUpsertDto extends CityEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${CityEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class CityUpsertInputDto extends CityCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof CityUpsertInputDto)[] = ['state_id', 'name', 'latitude'];
}
...
@ObjectType()
@Directive('@shareable')
export class CityUpsertOutputDto extends IntersectionType(CityCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class CitySoftRemoveDto extends CityEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${CityEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class CitySoftRemoveInputWhereDto extends CityFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class CitySoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [CitySoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CitySoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CitySoftRemoveOutputAffectedRowsDto extends CityFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CitySoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [CityEntity]) 
  declare affectedRows?: CityEntity[]
}
...
export class CityRemoveDto extends CityEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${CityEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class CityRemoveInputWhereDto extends CityFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class CityRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [CityRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where })
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CityRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CityRemoveOutputAffectedRowsDto extends CityFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CityRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CityRecoverDto extends CityEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${CityEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class CityRecoverInputWhereDto extends CityFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class CityRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [CityRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CityRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CityRecoverOutputAffectedRowsDto extends CityFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CityRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CityUploadDto extends CityEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${CityEntity?.metaname}${UploadArtefact}`;
...
@Field(() => CityUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: CityUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class CityUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class CityUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class CityUploadDeleteDto extends CityEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${CityEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class CityUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class CityUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
