...
import { LanguageEntityMeta as meta, LanguageEntity } from "../entities/language.entity";
...
import { LanguageUploadFileFieldEnum } from "../language.enum";
...
@Directive('@shareable')
export class LanguageDto extends LanguageEntity implements FindInputDtoCRUDTypeDefinition{
    /**
    ...
    declare id?: any;
    declare name?: any;
    declare iso_code?: any;
    declare latitude?: any;
    declare longitude?: any;
    declare macroarea?: any;
    declare created?: any;
    declare updated?: any;
    declare deleted?: any; 
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class LanguageFindDto extends LanguageEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${LanguageEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class LanguageFindInputWhereDto extends LanguageDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.iso_code.desc})
    @IsOptional()
    declare iso_code?: FindOperatorDto;
    ...
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.macroarea.desc})
    @IsOptional()
    declare macroarea?: FindOperatorDto;
...
@InputType()
export class LanguageFindInputSortOrderDto implements FindOptionsOrder<LanguageDto>, FindInputSortOrderCRUDTypeDefinition{
    
    @Field(() => RecordSortDirectionEnum, { nullable: true }) 
    @IsOptional()
    id?: RecordSortDirectionEnum;

    @Field(() => RecordSortDirectionEnum, {nullable: true, description: meta?.name.desc})
    @IsOptional()
    name?: RecordSortDirectionEnum;

    @Field(() => RecordSortDirectionEnum, {nullable: true, description: meta?.iso_code.desc})
    @IsOptional()
    iso_code?: RecordSortDirectionEnum;

    @Field(() => RecordSortDirectionEnum, {nullable: true, description: meta?.macroarea.desc})
    @IsOptional()
...
@InputType()
export class LanguageFindInputGroupByDto implements FindOptionsOrder<LanguageDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class LanguageFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<LanguageDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [LanguageFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<LanguageFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => LanguageFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by})
    @IsOptional()
    declare groupBy?: LanguageFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => LanguageFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<LanguageFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class LanguageFindOutputRowsDto extends LanguageFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class LanguageFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [LanguageEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: LanguageEntity[] | any;
}
...
export class LanguageFindOneByIdDto extends LanguageEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${LanguageEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class LanguageFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class LanguageCreateDto extends LanguageEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${LanguageEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class LanguageCreateInputDto extends  LanguageCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LanguageCreateOutputDto extends LanguageFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class LanguageUpdateDto extends LanguageDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${LanguageEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class LanguageUpdateInputWhereDto extends LanguageFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class LanguageUpdateInputSetsDto extends PartialType(LanguageCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class LanguageUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [LanguageUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<LanguageUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => LanguageUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets})
    @IsNotEmpty()
    sets!: LanguageUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class LanguageUpdateOutputAffectedRowsDto extends LanguageFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LanguageUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [LanguageEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: LanguageEntity[] | any;
}
...
export class LanguageSoftDeleteDto extends LanguageEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${LanguageEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class LanguageSoftDeleteInputWhereDto extends LanguageFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class LanguageSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [LanguageSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LanguageSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LanguageSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LanguageDeleteDto extends LanguageEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${LanguageEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class LanguageDeleteInputWhereDto extends LanguageFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LanguageDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [LanguageDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LanguageDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LanguageDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LanguageRestoreDto extends LanguageEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${LanguageEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class LanguageRestoreInputWhereDto extends LanguageFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LanguageRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [LanguageRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LanguageRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LanguageRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LanguageUpsertDto extends LanguageEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${LanguageEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class LanguageUpsertInputDto extends LanguageCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof LanguageUpsertInputDto)[] = [];
}
...
@ObjectType()
@Directive('@shareable')
export class LanguageUpsertOutputDto extends IntersectionType(LanguageCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class LanguageSoftRemoveDto extends LanguageEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${LanguageEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class LanguageSoftRemoveInputWhereDto extends LanguageFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class LanguageSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [LanguageSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LanguageSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LanguageSoftRemoveOutputAffectedRowsDto extends LanguageFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LanguageSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  declare affectedRows?: LanguageEntity[]
}
...
export class LanguageRemoveDto extends LanguageEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${LanguageEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class LanguageRemoveInputWhereDto extends LanguageFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class LanguageRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [LanguageRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where })
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LanguageRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LanguageRemoveOutputAffectedRowsDto extends LanguageFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LanguageRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LanguageRecoverDto extends LanguageEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${LanguageEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class LanguageRecoverInputWhereDto extends LanguageFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LanguageRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [LanguageRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LanguageRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LanguageRecoverOutputAffectedRowsDto extends LanguageFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LanguageRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LanguageUploadDto extends LanguageEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${LanguageEntity?.metaname}${UploadArtefact}`;
...
@Field(() => LanguageUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: LanguageUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class LanguageUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LanguageUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class LanguageUploadDeleteDto extends LanguageEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${LanguageEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class LanguageUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LanguageUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
