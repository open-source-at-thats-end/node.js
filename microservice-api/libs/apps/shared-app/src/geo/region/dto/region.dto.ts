...
import { RegionEntityMeta as meta, RegionEntity } from "../entities/region.entity";
...
import { RegionUploadFileFieldEnum } from "../region.enum";
...
@Directive('@shareable')
export class RegionDto extends RegionEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class RegionFindDto extends RegionEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${RegionEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class RegionFindInputWhereDto extends RegionDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => [SubregionFindInputWhereDto], {nullable: true, description: meta?.fr_subregions.desc})
    @IsOptional()
    declare fr_subregions?: SubregionFindInputWhereDto[];
...
@InputType()
export class RegionFindInputSortOrderDto implements FindOptionsOrder<RegionDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class RegionFindInputGroupByDto implements FindOptionsOrder<RegionDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class RegionFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<RegionDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [RegionFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<RegionFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => RegionFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: RegionFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => RegionFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<RegionFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class RegionFindOutputRowsDto extends RegionFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class RegionFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [RegionEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: RegionEntity | RegionEntity[] | any;
}
...
export class RegionFindOneByIdDto extends RegionEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${RegionEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class RegionFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class RegionCreateDto extends RegionEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${RegionEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class RegionCreateInputDto extends  RegionCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class RegionCreateOutputDto extends RegionFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class RegionUpdateDto extends RegionDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${RegionEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class RegionUpdateInputWhereDto extends RegionFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class RegionUpdateInputSetsDto extends PartialType(RegionCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class RegionUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [RegionUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<RegionUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => RegionUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: RegionUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class RegionUpdateOutputAffectedRowsDto extends RegionFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class RegionUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [RegionEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: RegionEntity[] | any; 
}
...
export class RegionSoftDeleteDto extends RegionEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${RegionEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class RegionSoftDeleteInputWhereDto extends RegionFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class RegionSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [RegionSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RegionSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RegionSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RegionDeleteDto extends RegionEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${RegionEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class RegionDeleteInputWhereDto extends RegionFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class RegionDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [RegionDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RegionDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RegionDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RegionRestoreDto extends RegionEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${RegionEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class RegionRestoreInputWhereDto extends RegionFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class RegionRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [RegionRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RegionRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RegionRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RegionUpsertDto extends RegionEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${RegionEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class RegionUpsertInputDto extends RegionCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof RegionUpsertInputDto)[] = ['name'];
}
...
@ObjectType()
@Directive('@shareable')
export class RegionUpsertOutputDto extends IntersectionType(RegionCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class RegionSoftRemoveDto extends RegionEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${RegionEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class RegionSoftRemoveInputWhereDto extends RegionFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class RegionSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [RegionSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RegionSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RegionSoftRemoveOutputAffectedRowsDto extends RegionFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class RegionSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RegionRemoveDto extends RegionEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${RegionEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class RegionRemoveInputWhereDto extends RegionFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class RegionRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [RegionRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RegionRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RegionRemoveOutputAffectedRowsDto extends RegionFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class RegionRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RegionRecoverDto extends RegionEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${RegionEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class RegionRecoverInputWhereDto extends RegionFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class RegionRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [RegionRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RegionRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RegionRecoverOutputAffectedRowsDto extends RegionFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class RegionRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RegionUploadDto extends RegionEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${RegionEntity?.metaname}${UploadArtefact}`;
...
@Field(() => RegionUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: RegionUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class RegionUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class RegionUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class RegionUploadDeleteDto extends RegionEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${RegionEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class RegionUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class RegionUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
