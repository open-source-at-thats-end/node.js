...
import { SubregionEntityMeta as meta, SubregionEntity } from "../entities/subregion.entity";
...
import { SubregionUploadFileFieldEnum } from "../subregion.enum";
...
@Directive('@shareable')
export class SubregionDto extends SubregionEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class SubregionFindDto extends SubregionEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${SubregionEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class SubregionFindInputWhereDto extends SubregionDto implements FindInputWhereCRUDTypeDefinition{
...
@InputType()
export class SubregionFindInputSortOrderDto implements FindOptionsOrder<SubregionDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class SubregionFindInputGroupByDto implements FindOptionsOrder<SubregionDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class SubregionFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<SubregionDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [SubregionFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<SubregionFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => SubregionFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: SubregionFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => SubregionFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<SubregionFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class SubregionFindOutputRowsDto extends SubregionFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class SubregionFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [SubregionEntity], {description:CrudDefMetaDesc.find_rows})
    declare rows?: SubregionEntity | SubregionEntity[] | any;
}
...
export class SubregionFindOneByIdDto extends SubregionEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${SubregionEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class SubregionFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class SubregionCreateDto extends SubregionEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${SubregionEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class SubregionCreateInputDto extends  SubregionCreateDto implements CreateInputCRUDTypeDefinition {

    @Field(() => Int, {nullable: false, description: meta?.region_id.desc})
...
@ObjectType()
@Directive('@shareable')
export class SubregionCreateOutputDto extends SubregionFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class SubregionUpdateDto extends SubregionDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${SubregionEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class SubregionUpdateInputWhereDto extends SubregionFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class SubregionUpdateInputSetsDto extends PartialType(SubregionCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class SubregionUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [SubregionUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<SubregionUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => SubregionUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: SubregionUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class SubregionUpdateOutputAffectedRowsDto extends SubregionFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SubregionUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [SubregionEntity], {description: CrudDefMetaDesc.update_affected_rows }) 
  declare affectedRows?: SubregionEntity[] | any; 
}
...
export class SubregionSoftDeleteDto extends SubregionEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${SubregionEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class SubregionSoftDeleteInputWhereDto extends SubregionFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class SubregionSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [SubregionSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SubregionSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SubregionSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SubregionDeleteDto extends SubregionEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${SubregionEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class SubregionDeleteInputWhereDto extends SubregionFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class SubregionDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [SubregionDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SubregionDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SubregionDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SubregionRestoreDto extends SubregionEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${SubregionEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class SubregionRestoreInputWhereDto extends SubregionFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class SubregionRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [SubregionRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SubregionRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SubregionRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SubregionUpsertDto extends SubregionEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${SubregionEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class SubregionUpsertInputDto extends SubregionCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof SubregionUpsertInputDto)[] = ['id','name'];
}
...
@ObjectType()
@Directive('@shareable')
export class SubregionUpsertOutputDto extends IntersectionType(SubregionCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class SubregionSoftRemoveDto extends SubregionEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${SubregionEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class SubregionSoftRemoveInputWhereDto extends SubregionFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class SubregionSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [SubregionSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SubregionSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SubregionSoftRemoveOutputAffectedRowsDto extends SubregionFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SubregionSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SubregionRemoveDto extends SubregionEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${SubregionEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class SubregionRemoveInputWhereDto extends SubregionFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class SubregionRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [SubregionRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SubregionRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SubregionRemoveOutputAffectedRowsDto extends SubregionFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SubregionRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SubregionRecoverDto extends SubregionEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${SubregionEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class SubregionRecoverInputWhereDto extends SubregionFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class SubregionRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [SubregionRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<SubregionRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class SubregionRecoverOutputAffectedRowsDto extends SubregionFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class SubregionRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class SubregionUploadDto extends SubregionEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${SubregionEntity?.metaname}${UploadArtefact}`;
...
@Field(() => SubregionUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: SubregionUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class SubregionUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class SubregionUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class SubregionUploadDeleteDto extends SubregionEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${SubregionEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class SubregionUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class SubregionUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
