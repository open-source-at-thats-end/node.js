...
import { MeasurementCategoryEntityMeta as meta, MeasurementCategoryEntity } from "../entities/measurement.category.entity";
...
import { MeasurementCategoryUploadFileFieldEnum } from "../category.enum";
import { MeasurementUnitFindInputWhereDto } from "../../unit/dto/unit.dto";
...
@Directive('@shareable')
export class MeasurementCategoryDto extends MeasurementCategoryEntity implements FindInputDtoCRUDTypeDefinition{
     /**
     ...
     **/
     ...
     declare fr_measurement_units?: any;
}
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class MeasurementCategoryFindDto extends MeasurementCategoryEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${MeasurementCategoryEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class MeasurementCategoryFindInputWhereDto extends MeasurementCategoryDto implements FindInputWhereCRUDTypeDefinition{
...
// ████ FR_ WHERE: INTERNAL RELATIONS WHERE ████████████████████████████████████████████████
   ...
   @Field(() => [MeasurementUnitFindInputWhereDto], {nullable: true, description: meta?.fr_measurement_units.desc})
   @IsOptional()
   declare fr_measurement_units?: MeasurementUnitFindInputWhereDto[]; 

}

@InputType()
export class MeasurementCategoryFindInputSortOrderDto implements FindOptionsOrder<MeasurementCategoryDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class MeasurementCategoryFindInputGroupByDto implements FindOptionsOrder<MeasurementCategoryDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class MeasurementCategoryFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<MeasurementCategoryDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [MeasurementCategoryFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<MeasurementCategoryFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => MeasurementCategoryFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: MeasurementCategoryFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => MeasurementCategoryFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<MeasurementCategoryFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryFindOutputRowsDto extends MeasurementCategoryFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [MeasurementCategoryEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: MeasurementCategoryEntity | MeasurementCategoryEntity[] | any;
}
...
export class MeasurementCategoryFindOneByIdDto extends MeasurementCategoryEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${MeasurementCategoryEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class MeasurementCategoryFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class MeasurementCategoryCreateDto extends MeasurementCategoryEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${MeasurementCategoryEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class MeasurementCategoryCreateInputDto extends  MeasurementCategoryCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryCreateOutputDto extends MeasurementCategoryFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class MeasurementCategoryUpdateDto extends MeasurementCategoryDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${MeasurementCategoryEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class MeasurementCategoryUpdateInputWhereDto extends MeasurementCategoryFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class MeasurementCategoryUpdateInputSetsDto extends PartialType(MeasurementCategoryCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class MeasurementCategoryUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [MeasurementCategoryUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<MeasurementCategoryUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => MeasurementCategoryUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: MeasurementCategoryUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryUpdateOutputAffectedRowsDto extends MeasurementCategoryFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [MeasurementCategoryEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: MeasurementCategoryEntity[] | any; 
}
...
export class MeasurementCategorySoftDeleteDto extends MeasurementCategoryEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementCategoryEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class MeasurementCategorySoftDeleteInputWhereDto extends MeasurementCategoryFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class MeasurementCategorySoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [MeasurementCategorySoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementCategorySoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategorySoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementCategoryDeleteDto extends MeasurementCategoryEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementCategoryEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class MeasurementCategoryDeleteInputWhereDto extends MeasurementCategoryFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class MeasurementCategoryDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [MeasurementCategoryDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementCategoryDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementCategoryRestoreDto extends MeasurementCategoryEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${MeasurementCategoryEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class MeasurementCategoryRestoreInputWhereDto extends MeasurementCategoryFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class MeasurementCategoryRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [MeasurementCategoryRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementCategoryRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementCategoryUpsertDto extends MeasurementCategoryEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementCategoryEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class MeasurementCategoryUpsertInputDto extends MeasurementCategoryCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof MeasurementCategoryUpsertInputDto)[] = ['title'];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryUpsertOutputDto extends IntersectionType(MeasurementCategoryCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class MeasurementCategorySoftRemoveDto extends MeasurementCategoryEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementCategoryEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class MeasurementCategorySoftRemoveInputWhereDto extends MeasurementCategoryFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class MeasurementCategorySoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [MeasurementCategorySoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementCategorySoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategorySoftRemoveOutputAffectedRowsDto extends MeasurementCategoryFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategorySoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [MeasurementCategoryEntity]) 
  declare affectedRows?: MeasurementCategoryEntity[] | any
}
...
export class MeasurementCategoryRemoveDto extends MeasurementCategoryEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementCategoryEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class MeasurementCategoryRemoveInputWhereDto extends MeasurementCategoryFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class MeasurementCategoryRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [MeasurementCategoryRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementCategoryRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryRemoveOutputAffectedRowsDto extends MeasurementCategoryFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementCategoryRecoverDto extends MeasurementCategoryEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementCategoryEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class MeasurementCategoryRecoverInputWhereDto extends MeasurementCategoryFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class MeasurementCategoryRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [MeasurementCategoryRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementCategoryRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryRecoverOutputAffectedRowsDto extends MeasurementCategoryFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementCategoryUploadDto extends MeasurementCategoryEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${MeasurementCategoryEntity?.metaname}${UploadArtefact}`;
...
@Field(() => MeasurementCategoryUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: MeasurementCategoryUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class MeasurementCategoryUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class MeasurementCategoryUploadDeleteDto extends MeasurementCategoryEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${MeasurementCategoryEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class MeasurementCategoryUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class MeasurementCategoryUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
