...
import { MeasurementUnitEntityMeta as meta, MeasurementUnitEntity } from "../entities/unit.entity";
...
import { MeasurementUnitUploadFileFieldEnum } from "../unit.enum";
import { MeasurementCategoryFindInputWhereDto } from "../../category/dto/category.dto";
...
@Directive('@shareable')
export class MeasurementUnitDto extends MeasurementUnitEntity implements FindInputDtoCRUDTypeDefinition{
     /**
     ...
     **/
     ...
     declare short_desc?: any;
     declare created?: any;
     declare updated?: any;
     declare deleted?: any;

     declare fr_newsletter_user?: any;
     declare fr_mu_category?: any;
}
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class MeasurementUnitFindDto extends MeasurementUnitEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${MeasurementUnitEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class MeasurementUnitFindInputWhereDto extends MeasurementUnitDto implements FindInputWhereCRUDTypeDefinition{
  @Field(() => FindOperatorDto, {nullable: true, description: meta?.id.desc})
  @IsOptional()
  declare id?: FindOperatorDto;    

  @Field(() => FindOperatorDto, {nullable: true, description: meta?.mcat_id.desc})
  @IsOptional()
  declare mcat_id?: FindOperatorDto;
...
// ████ FR_ WHERE: INTERNAL RELATIONS WHERE ████████████████████████████████████████████████
   ...
   @Field(() => [MeasurementCategoryFindInputWhereDto], {nullable: true, description: meta?.fr_mu_category.desc})
   @IsOptional()
   declare fr_mu_category?: MeasurementCategoryFindInputWhereDto[]; 
}

@InputType()
export class MeasurementUnitFindInputSortOrderDto implements FindOptionsOrder<MeasurementUnitDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class MeasurementUnitFindInputGroupByDto implements FindOptionsOrder<MeasurementUnitDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class MeasurementUnitFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<MeasurementUnitDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [MeasurementUnitFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<MeasurementUnitFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => MeasurementUnitFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: MeasurementUnitFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => MeasurementUnitFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<MeasurementUnitFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitFindOutputRowsDto extends MeasurementUnitFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class MeasurementUnitFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [MeasurementUnitEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: MeasurementUnitEntity | MeasurementUnitEntity[] | any;
}
...
export class MeasurementUnitFindOneByIdDto extends MeasurementUnitEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${MeasurementUnitEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class MeasurementUnitFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class MeasurementUnitCreateDto extends MeasurementUnitEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${MeasurementUnitEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class MeasurementUnitCreateInputDto extends  MeasurementUnitCreateDto implements CreateInputCRUDTypeDefinition {
  
  @Field(() => Int, {nullable: true, description: meta?.mcat_id.desc}) 
  declare mcat_id?: number;
  
  @Field(() => String, {nullable: false, description: meta?.name.desc})
  declare name: string;

  @Field(() => String, {nullable: false, description: meta?.abbreviation.desc}) 
  declare abbreviation: string;

  @Field(() => String, {nullable: false, description: meta?.short_desc.desc})
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitCreateOutputDto extends MeasurementUnitFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class MeasurementUnitUpdateDto extends MeasurementUnitDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${MeasurementUnitEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class MeasurementUnitUpdateInputWhereDto extends MeasurementUnitFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class MeasurementUnitUpdateInputSetsDto extends PartialType(MeasurementUnitCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class MeasurementUnitUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [MeasurementUnitUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<MeasurementUnitUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => MeasurementUnitUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: MeasurementUnitUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitUpdateOutputAffectedRowsDto extends MeasurementUnitFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [MeasurementUnitEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: MeasurementUnitEntity[] | any; 
}
...
export class MeasurementUnitSoftDeleteDto extends MeasurementUnitEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementUnitEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class MeasurementUnitSoftDeleteInputWhereDto extends MeasurementUnitFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class MeasurementUnitSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [MeasurementUnitSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementUnitSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementUnitDeleteDto extends MeasurementUnitEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementUnitEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class MeasurementUnitDeleteInputWhereDto extends MeasurementUnitFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class MeasurementUnitDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [MeasurementUnitDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementUnitDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementUnitRestoreDto extends MeasurementUnitEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${MeasurementUnitEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class MeasurementUnitRestoreInputWhereDto extends MeasurementUnitFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class MeasurementUnitRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [MeasurementUnitRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementUnitRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementUnitUpsertDto extends MeasurementUnitEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementUnitEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class MeasurementUnitUpsertInputDto extends MeasurementUnitCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof MeasurementUnitUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitUpsertOutputDto extends IntersectionType(MeasurementUnitCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class MeasurementUnitSoftRemoveDto extends MeasurementUnitEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementUnitEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class MeasurementUnitSoftRemoveInputWhereDto extends MeasurementUnitFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class MeasurementUnitSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [MeasurementUnitSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementUnitSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitSoftRemoveOutputAffectedRowsDto extends MeasurementUnitFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementUnitRemoveDto extends MeasurementUnitEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementUnitEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class MeasurementUnitRemoveInputWhereDto extends MeasurementUnitFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class MeasurementUnitRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [MeasurementUnitRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementUnitRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitRemoveOutputAffectedRowsDto extends MeasurementUnitFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementUnitRecoverDto extends MeasurementUnitEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${MeasurementUnitEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class MeasurementUnitRecoverInputWhereDto extends MeasurementUnitFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class MeasurementUnitRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [MeasurementUnitRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<MeasurementUnitRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitRecoverOutputAffectedRowsDto extends MeasurementUnitFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class MeasurementUnitUploadDto extends MeasurementUnitEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${MeasurementUnitEntity?.metaname}${UploadArtefact}`;
...
@Field(() => MeasurementUnitUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: MeasurementUnitUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class MeasurementUnitUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class MeasurementUnitUploadDeleteDto extends MeasurementUnitEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${MeasurementUnitEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class MeasurementUnitUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class MeasurementUnitUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
