...
import { ConnectionSourceEntityMeta as meta, ConnectionSourceEntity } from "../entities/source.entity";
...
import { ConnectionSourceUploadFileFieldEnum } from "../source.enum";
import { ConnectionSourceCategoriesFindInputWhereDto } from "../../source-categories/dto/source.categories.dto";
...
@Directive('@shareable')
export class ConnectionSourceDto extends ConnectionSourceEntity implements FindInputDtoCRUDTypeDefinition{
     /**
     ...
     **/
     ...
     declare fr_connection_source_categories_info?: any;
     declare fr_user?:any;
}
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class ConnectionSourceFindDto extends ConnectionSourceEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceFindInputWhereDto extends ConnectionSourceDto implements FindInputWhereCRUDTypeDefinition{
  @Field(() => FindOperatorDto, {nullable: true, description: meta?.id.desc})
  @IsOptional()
  declare id?: FindOperatorDto;    

  @Field(() => FindOperatorDto, {nullable: true, description: meta?.connsrccat_id.desc})
  @IsOptional()
  ...
  @Field(() => [ConnectionSourceCategoriesFindInputWhereDto], {nullable: true, description: meta?.fr_connection_source_categories_info.desc})
  @IsOptional()
  declare fr_connection_source_categories_info?: ConnectionSourceCategoriesFindInputWhereDto[];
...
@InputType()
export class ConnectionSourceFindInputSortOrderDto implements FindOptionsOrder<ConnectionSourceDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceFindInputGroupByDto implements FindOptionsOrder<ConnectionSourceDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<ConnectionSourceDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [ConnectionSourceFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<ConnectionSourceFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => ConnectionSourceFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
     ...
     */
    @Field(() => ConnectionSourceFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<ConnectionSourceFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceFindOutputRowsDto extends ConnectionSourceFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class ConnectionSourceFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [ConnectionSourceEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: ConnectionSourceEntity | ConnectionSourceEntity[] | any;
}
...
export class ConnectionSourceFindOneByIdDto extends ConnectionSourceEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class ConnectionSourceCreateDto extends ConnectionSourceEntity implements CreateDtoCRUDTypeDefinition {
...
@InputType()
export class ConnectionSourceCreateInputDto extends  ConnectionSourceCreateDto implements CreateInputCRUDTypeDefinition {

  @Field(() => Int, {nullable: false, description: meta?.connsrccat_id.desc})
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCreateOutputDto extends ConnectionSourceFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class ConnectionSourceUpdateDto extends ConnectionSourceDto implements UpdateDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceUpdateInputWhereDto extends ConnectionSourceFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class ConnectionSourceUpdateInputSetsDto extends PartialType(ConnectionSourceCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class ConnectionSourceUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [ConnectionSourceUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<ConnectionSourceUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => ConnectionSourceUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: ConnectionSourceUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceUpdateOutputAffectedRowsDto extends ConnectionSourceFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: ConnectionSourceEntity[] | any; 
}
...
export class ConnectionSourceSoftDeleteDto extends ConnectionSourceEntity implements SoftDeleteDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceSoftDeleteInputWhereDto extends ConnectionSourceFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class ConnectionSourceSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceDeleteDto extends ConnectionSourceEntity implements DeleteDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceDeleteInputWhereDto extends ConnectionSourceFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class ConnectionSourceDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceRestoreDto extends ConnectionSourceEntity implements RestoreDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceRestoreInputWhereDto extends ConnectionSourceFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class ConnectionSourceRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceUpsertDto extends ConnectionSourceEntity implements UpsertDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceUpsertInputDto extends ConnectionSourceCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof ConnectionSourceUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceUpsertOutputDto extends IntersectionType(ConnectionSourceCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class ConnectionSourceSoftRemoveDto extends ConnectionSourceEntity implements SoftRemoveDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceSoftRemoveInputWhereDto extends ConnectionSourceFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class ConnectionSourceSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceSoftRemoveOutputAffectedRowsDto extends ConnectionSourceFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceRemoveDto extends ConnectionSourceEntity implements RemoveDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceRemoveInputWhereDto extends ConnectionSourceFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class ConnectionSourceRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceRemoveOutputAffectedRowsDto extends ConnectionSourceFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceRecoverDto extends ConnectionSourceEntity implements RecoverDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceRecoverInputWhereDto extends ConnectionSourceFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class ConnectionSourceRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceRecoverOutputAffectedRowsDto extends ConnectionSourceFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceUploadDto extends ConnectionSourceEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${ConnectionSourceEntity?.metaname}${UploadArtefact}`;
...
@Field(() => ConnectionSourceUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: ConnectionSourceUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class ConnectionSourceUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class ConnectionSourceUploadDeleteDto extends ConnectionSourceEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${ConnectionSourceEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class ConnectionSourceUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
