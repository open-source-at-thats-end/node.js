...
import { ConnectionSourceCategoriesEntityMeta as meta, ConnectionSourceCategoriesEntity } from "../entities/source.categories.entity";
...
import { ConnectionSourceCategoriesUploadFileFieldEnum } from "../source.categories.enum";
import { ConnectionSourceFindInputWhereDto } from "../../source/dto/source.dto";
...
@Directive('@shareable')
export class ConnectionSourceCategoriesDto extends ConnectionSourceCategoriesEntity implements FindInputDtoCRUDTypeDefinition{
     /**
     ...
     **/
     ...
     declare fr_connection_sources_info?: any;
}
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class ConnectionSourceCategoriesFindDto extends ConnectionSourceCategoriesEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesFindInputWhereDto extends ConnectionSourceCategoriesDto implements FindInputWhereCRUDTypeDefinition{
  ...
  declare deleted?: FindOperatorDto; 
    ...
    @Field(() => [ConnectionSourceFindInputWhereDto], {nullable: true, description: meta?.fr_connection_sources_info.desc})
    @IsOptional()
    declare fr_connection_sources_info?: ConnectionSourceFindInputWhereDto[];
}

@InputType()
export class ConnectionSourceCategoriesFindInputSortOrderDto implements FindOptionsOrder<ConnectionSourceCategoriesDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesFindInputGroupByDto implements FindOptionsOrder<ConnectionSourceCategoriesDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<ConnectionSourceCategoriesDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [ConnectionSourceCategoriesFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<ConnectionSourceCategoriesFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => ConnectionSourceCategoriesFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
     ...
     */
    @Field(() => ConnectionSourceCategoriesFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<ConnectionSourceCategoriesFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesFindOutputRowsDto extends ConnectionSourceCategoriesFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [ConnectionSourceCategoriesEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: ConnectionSourceCategoriesEntity | ConnectionSourceCategoriesEntity[] | any;
}
...
export class ConnectionSourceCategoriesFindOneByIdDto extends ConnectionSourceCategoriesEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class ConnectionSourceCategoriesCreateDto extends ConnectionSourceCategoriesEntity implements CreateDtoCRUDTypeDefinition {
...
@InputType()
export class ConnectionSourceCategoriesCreateInputDto extends  ConnectionSourceCategoriesCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesCreateOutputDto extends ConnectionSourceCategoriesFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class ConnectionSourceCategoriesUpdateDto extends ConnectionSourceCategoriesDto implements UpdateDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesUpdateInputWhereDto extends ConnectionSourceCategoriesFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class ConnectionSourceCategoriesUpdateInputSetsDto extends PartialType(ConnectionSourceCategoriesCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class ConnectionSourceCategoriesUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [ConnectionSourceCategoriesUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<ConnectionSourceCategoriesUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => ConnectionSourceCategoriesUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: ConnectionSourceCategoriesUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesUpdateOutputAffectedRowsDto extends ConnectionSourceCategoriesFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceCategoriesEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: ConnectionSourceCategoriesEntity[] | any; 
}
...
export class ConnectionSourceCategoriesSoftDeleteDto extends ConnectionSourceCategoriesEntity implements SoftDeleteDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesSoftDeleteInputWhereDto extends ConnectionSourceCategoriesFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class ConnectionSourceCategoriesSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceCategoriesSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceCategoriesSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceCategoriesDeleteDto extends ConnectionSourceCategoriesEntity implements DeleteDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesDeleteInputWhereDto extends ConnectionSourceCategoriesFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class ConnectionSourceCategoriesDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceCategoriesDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceCategoriesDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceCategoriesRestoreDto extends ConnectionSourceCategoriesEntity implements RestoreDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesRestoreInputWhereDto extends ConnectionSourceCategoriesFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class ConnectionSourceCategoriesRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceCategoriesRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceCategoriesRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceCategoriesUpsertDto extends ConnectionSourceCategoriesEntity implements UpsertDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesUpsertInputDto extends ConnectionSourceCategoriesCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof ConnectionSourceCategoriesUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesUpsertOutputDto extends IntersectionType(ConnectionSourceCategoriesCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class ConnectionSourceCategoriesSoftRemoveDto extends ConnectionSourceCategoriesEntity implements SoftRemoveDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesSoftRemoveInputWhereDto extends ConnectionSourceCategoriesFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class ConnectionSourceCategoriesSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceCategoriesSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceCategoriesSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesSoftRemoveOutputAffectedRowsDto extends ConnectionSourceCategoriesFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceCategoriesRemoveDto extends ConnectionSourceCategoriesEntity implements RemoveDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesRemoveInputWhereDto extends ConnectionSourceCategoriesFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class ConnectionSourceCategoriesRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceCategoriesRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceCategoriesRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesRemoveOutputAffectedRowsDto extends ConnectionSourceCategoriesFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceCategoriesRecoverDto extends ConnectionSourceCategoriesEntity implements RecoverDtoCRUDTypeDefinition{
...
@InputType()
export class ConnectionSourceCategoriesRecoverInputWhereDto extends ConnectionSourceCategoriesFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class ConnectionSourceCategoriesRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [ConnectionSourceCategoriesRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<ConnectionSourceCategoriesRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesRecoverOutputAffectedRowsDto extends ConnectionSourceCategoriesFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class ConnectionSourceCategoriesUploadDto extends ConnectionSourceCategoriesEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${ConnectionSourceCategoriesEntity?.metaname}${UploadArtefact}`;
...
@Field(() => ConnectionSourceCategoriesUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: ConnectionSourceCategoriesUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class ConnectionSourceCategoriesUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class ConnectionSourceCategoriesUploadDeleteDto extends ConnectionSourceCategoriesEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${ConnectionSourceCategoriesEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class ConnectionSourceCategoriesUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class ConnectionSourceCategoriesUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
