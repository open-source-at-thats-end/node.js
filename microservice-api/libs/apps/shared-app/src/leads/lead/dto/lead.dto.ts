...
import { LeadEntityMeta as meta, LeadEntity } from "../entities/lead.entity";
...
import { LeadUploadFileFieldEnum } from "../lead.enum";
...
@Directive('@shareable')
export class LeadDto extends LeadEntity implements FindInputDtoCRUDTypeDefinition{
     /**
     ...
     **/
     ...
     declare first_incoming_message_dt?: any;
     declare created?: any;
     declare updated?: any;
     declare deleted?: any;
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class LeadFindDto extends LeadEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class LeadFindInputWhereDto extends LeadDto implements FindInputWhereCRUDTypeDefinition{
  ...
  @Field(() => FindOperatorDto, {nullable: true, description: meta?.first_incoming_message_dt.desc})
  @IsOptional()
  declare first_incoming_message_dt?: FindOperatorDto;
...
@InputType()
export class LeadFindInputSortOrderDto implements FindOptionsOrder<LeadDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class LeadFindInputGroupByDto implements FindOptionsOrder<LeadDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class LeadFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<LeadDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [LeadFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<LeadFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => LeadFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
     ...
     */
    @Field(() => LeadFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<LeadFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFindOutputRowsDto extends LeadFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class LeadFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [LeadEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: LeadEntity | LeadEntity[] | any;
}
...
export class LeadFindOneByIdDto extends LeadEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class LeadFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class LeadCreateDto extends LeadEntity implements CreateDtoCRUDTypeDefinition {
...
@InputType()
export class LeadCreateInputDto extends  LeadCreateDto implements CreateInputCRUDTypeDefinition {
  ...
  declare first_incoming_message_dt?: Date;
}
...
@ObjectType()
@Directive('@shareable')
export class LeadCreateOutputDto extends LeadFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class LeadUpdateDto extends LeadDto implements UpdateDtoCRUDTypeDefinition{
...
@InputType()
export class LeadUpdateInputWhereDto extends LeadFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class LeadUpdateInputSetsDto extends PartialType(LeadCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class LeadUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [LeadUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<LeadUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => LeadUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: LeadUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class LeadUpdateOutputAffectedRowsDto extends LeadFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [LeadEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: LeadEntity[] | any; 
}
...
export class LeadSoftDeleteDto extends LeadEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${LeadEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class LeadSoftDeleteInputWhereDto extends LeadFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class LeadSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [LeadSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadDeleteDto extends LeadEntity implements DeleteDtoCRUDTypeDefinition{
...
@InputType()
export class LeadDeleteInputWhereDto extends LeadFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [LeadDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadRestoreDto extends LeadEntity implements RestoreDtoCRUDTypeDefinition{
...
@InputType()
export class LeadRestoreInputWhereDto extends LeadFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [LeadRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadUpsertDto extends LeadEntity implements UpsertDtoCRUDTypeDefinition{
...
@InputType()
export class LeadUpsertInputDto extends LeadCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof LeadUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadUpsertOutputDto extends IntersectionType(LeadCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class LeadSoftRemoveDto extends LeadEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${LeadEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class LeadSoftRemoveInputWhereDto extends LeadFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class LeadSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [LeadSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadSoftRemoveOutputAffectedRowsDto extends LeadFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadRemoveDto extends LeadEntity implements RemoveDtoCRUDTypeDefinition{
...
@InputType()
export class LeadRemoveInputWhereDto extends LeadFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [LeadRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadRemoveOutputAffectedRowsDto extends LeadFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadRecoverDto extends LeadEntity implements RecoverDtoCRUDTypeDefinition{
...
@InputType()
export class LeadRecoverInputWhereDto extends LeadFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [LeadRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadRecoverOutputAffectedRowsDto extends LeadFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadUploadDto extends LeadEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${LeadEntity?.metaname}${UploadArtefact}`;
...
@Field(() => LeadUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: LeadUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class LeadUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class LeadUploadDeleteDto extends LeadEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${LeadEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class LeadUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
