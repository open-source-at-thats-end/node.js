...
import { LeadFollowupStatusEntityMeta as meta, LeadFollowupStatusEntity } from "../entities/followup.status.entity";
...
import { LeadFollowupStatusUploadFileFieldEnum } from "../followup.status.enum";
...
@Directive('@shareable')
export class LeadFollowupStatusDto extends LeadFollowupStatusEntity implements FindInputDtoCRUDTypeDefinition{
     /**
     ...
     **/
     ...
     declare fr_lead_followups_status?: any;
}
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class LeadFollowupStatusFindDto extends LeadFollowupStatusEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${LeadFollowupStatusEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class LeadFollowupStatusFindInputWhereDto extends LeadFollowupStatusDto implements FindInputWhereCRUDTypeDefinition{
  ...
  declare deleted?: FindOperatorDto; 
    ...
    @Field(() => [LeadFollowupFindInputWhereDto], {nullable: true, description: meta?.fr_lead_followups_status.desc})
    @IsOptional()
    declare fr_lead_followups_status?: LeadFollowupFindInputWhereDto[];
    
}

@InputType()
export class LeadFollowupStatusFindInputSortOrderDto implements FindOptionsOrder<LeadFollowupStatusDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class LeadFollowupStatusFindInputGroupByDto implements FindOptionsOrder<LeadFollowupStatusDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class LeadFollowupStatusFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<LeadFollowupStatusDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [LeadFollowupStatusFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<LeadFollowupStatusFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => LeadFollowupStatusFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: LeadFollowupStatusFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => LeadFollowupStatusFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<LeadFollowupStatusFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusFindOutputRowsDto extends LeadFollowupStatusFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [LeadFollowupStatusEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: LeadFollowupStatusEntity | LeadFollowupStatusEntity[] | any;
}
...
export class LeadFollowupStatusFindOneByIdDto extends LeadFollowupStatusEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${LeadFollowupStatusEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class LeadFollowupStatusFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class LeadFollowupStatusCreateDto extends LeadFollowupStatusEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${LeadFollowupStatusEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class LeadFollowupStatusCreateInputDto extends  LeadFollowupStatusCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusCreateOutputDto extends LeadFollowupStatusFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class LeadFollowupStatusUpdateDto extends LeadFollowupStatusDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${LeadFollowupStatusEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class LeadFollowupStatusUpdateInputWhereDto extends LeadFollowupStatusFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class LeadFollowupStatusUpdateInputSetsDto extends PartialType(LeadFollowupStatusCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class LeadFollowupStatusUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [LeadFollowupStatusUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<LeadFollowupStatusUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => LeadFollowupStatusUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: LeadFollowupStatusUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusUpdateOutputAffectedRowsDto extends LeadFollowupStatusFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [LeadFollowupStatusEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: LeadFollowupStatusEntity[] | any; 
}
...
export class LeadFollowupStatusSoftDeleteDto extends LeadFollowupStatusEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupStatusEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class LeadFollowupStatusSoftDeleteInputWhereDto extends LeadFollowupStatusFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class LeadFollowupStatusSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupStatusSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupStatusSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupStatusDeleteDto extends LeadFollowupStatusEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupStatusEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class LeadFollowupStatusDeleteInputWhereDto extends LeadFollowupStatusFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadFollowupStatusDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupStatusDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupStatusDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupStatusRestoreDto extends LeadFollowupStatusEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${LeadFollowupStatusEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class LeadFollowupStatusRestoreInputWhereDto extends LeadFollowupStatusFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadFollowupStatusRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupStatusRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupStatusRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupStatusUpsertDto extends LeadFollowupStatusEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupStatusEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class LeadFollowupStatusUpsertInputDto extends LeadFollowupStatusCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof LeadFollowupStatusUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusUpsertOutputDto extends IntersectionType(LeadFollowupStatusCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class LeadFollowupStatusSoftRemoveDto extends LeadFollowupStatusEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupStatusEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class LeadFollowupStatusSoftRemoveInputWhereDto extends LeadFollowupStatusFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class LeadFollowupStatusSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupStatusSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupStatusSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusSoftRemoveOutputAffectedRowsDto extends LeadFollowupStatusFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupStatusRemoveDto extends LeadFollowupStatusEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupStatusEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class LeadFollowupStatusRemoveInputWhereDto extends LeadFollowupStatusFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadFollowupStatusRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupStatusRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupStatusRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusRemoveOutputAffectedRowsDto extends LeadFollowupStatusFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupStatusRecoverDto extends LeadFollowupStatusEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupStatusEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class LeadFollowupStatusRecoverInputWhereDto extends LeadFollowupStatusFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadFollowupStatusRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupStatusRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupStatusRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusRecoverOutputAffectedRowsDto extends LeadFollowupStatusFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupStatusUploadDto extends LeadFollowupStatusEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${LeadFollowupStatusEntity?.metaname}${UploadArtefact}`;
...
@Field(() => LeadFollowupStatusUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: LeadFollowupStatusUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class LeadFollowupStatusUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class LeadFollowupStatusUploadDeleteDto extends LeadFollowupStatusEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${LeadFollowupStatusEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class LeadFollowupStatusUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupStatusUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
