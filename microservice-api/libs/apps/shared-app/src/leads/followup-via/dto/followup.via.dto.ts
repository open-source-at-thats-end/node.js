...
import { LeadFollowupViaEntityMeta as meta, LeadFollowupViaEntity } from "../entities/followup.via.entity";
...
import { LeadFollowupViaUploadFileFieldEnum } from "../followup.via.enum";
import { LeadFollowupFindInputWhereDto } from "../../followup/dto/followup.dto";
...
@Directive('@shareable')
export class LeadFollowupViaDto extends LeadFollowupViaEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class LeadFollowupViaFindDto extends LeadFollowupViaEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${LeadFollowupViaEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class LeadFollowupViaFindInputWhereDto extends LeadFollowupViaDto implements FindInputWhereCRUDTypeDefinition{
  ...
  @Field(() => FindOperatorDto, {nullable: true, description: meta?.desc.desc})
  @IsOptional()
  declare desc?: FindOperatorDto;
...
// ████ FR_ WHERE: INTERNAL RELATIONS WHERE ████████████████████████████████████████████████
    ...
    @Field(() => [LeadFollowupFindInputWhereDto], {nullable: true, description: meta?.fr_lead_followups.desc})
    @IsOptional()
    declare fr_lead_followups?: LeadFollowupFindInputWhereDto[];
}

@InputType()
export class LeadFollowupViaFindInputSortOrderDto implements FindOptionsOrder<LeadFollowupViaDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class LeadFollowupViaFindInputGroupByDto implements FindOptionsOrder<LeadFollowupViaDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class LeadFollowupViaFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<LeadFollowupViaDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [LeadFollowupViaFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<LeadFollowupViaFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => LeadFollowupViaFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: LeadFollowupViaFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => LeadFollowupViaFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<LeadFollowupViaFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaFindOutputRowsDto extends LeadFollowupViaFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [LeadFollowupViaEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: LeadFollowupViaEntity | LeadFollowupViaEntity[] | any;
}
...
export class LeadFollowupViaFindOneByIdDto extends LeadFollowupViaEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${LeadFollowupViaEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class LeadFollowupViaFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class LeadFollowupViaCreateDto extends LeadFollowupViaEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${LeadFollowupViaEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class LeadFollowupViaCreateInputDto extends  LeadFollowupViaCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaCreateOutputDto extends LeadFollowupViaFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class LeadFollowupViaUpdateDto extends LeadFollowupViaDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${LeadFollowupViaEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class LeadFollowupViaUpdateInputWhereDto extends LeadFollowupViaFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class LeadFollowupViaUpdateInputSetsDto extends PartialType(LeadFollowupViaCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class LeadFollowupViaUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [LeadFollowupViaUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<LeadFollowupViaUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => LeadFollowupViaUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: LeadFollowupViaUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaUpdateOutputAffectedRowsDto extends LeadFollowupViaFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [LeadFollowupViaEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: LeadFollowupViaEntity[] | any; 
}
...
export class LeadFollowupViaSoftDeleteDto extends LeadFollowupViaEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupViaEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class LeadFollowupViaSoftDeleteInputWhereDto extends LeadFollowupViaFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class LeadFollowupViaSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupViaSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupViaSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupViaDeleteDto extends LeadFollowupViaEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupViaEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class LeadFollowupViaDeleteInputWhereDto extends LeadFollowupViaFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadFollowupViaDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupViaDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupViaDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupViaRestoreDto extends LeadFollowupViaEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${LeadFollowupViaEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class LeadFollowupViaRestoreInputWhereDto extends LeadFollowupViaFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadFollowupViaRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupViaRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupViaRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupViaUpsertDto extends LeadFollowupViaEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupViaEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class LeadFollowupViaUpsertInputDto extends LeadFollowupViaCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof LeadFollowupViaUpsertInputDto)[] = ['title'];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaUpsertOutputDto extends IntersectionType(LeadFollowupViaCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class LeadFollowupViaSoftRemoveDto extends LeadFollowupViaEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupViaEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class LeadFollowupViaSoftRemoveInputWhereDto extends LeadFollowupViaFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class LeadFollowupViaSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupViaSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupViaSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaSoftRemoveOutputAffectedRowsDto extends LeadFollowupViaFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupViaRemoveDto extends LeadFollowupViaEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupViaEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class LeadFollowupViaRemoveInputWhereDto extends LeadFollowupViaFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadFollowupViaRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupViaRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupViaRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaRemoveOutputAffectedRowsDto extends LeadFollowupViaFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupViaRecoverDto extends LeadFollowupViaEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${LeadFollowupViaEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class LeadFollowupViaRecoverInputWhereDto extends LeadFollowupViaFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadFollowupViaRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [LeadFollowupViaRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadFollowupViaRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaRecoverOutputAffectedRowsDto extends LeadFollowupViaFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadFollowupViaUploadDto extends LeadFollowupViaEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${LeadFollowupViaEntity?.metaname}${UploadArtefact}`;
...
@Field(() => LeadFollowupViaUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: LeadFollowupViaUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class LeadFollowupViaUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class LeadFollowupViaUploadDeleteDto extends LeadFollowupViaEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${LeadFollowupViaEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class LeadFollowupViaUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadFollowupViaUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
