...
import { LeadPotentialEntityMeta as meta, LeadPotentialEntity } from "../entities/potential.entity";
...
import { LeadPotentialUploadFileFieldEnum } from "../potential.enum";
...
@Directive('@shareable')
export class LeadPotentialDto extends LeadPotentialEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class LeadPotentialFindDto extends LeadPotentialEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${LeadPotentialEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class LeadPotentialFindInputWhereDto extends LeadPotentialDto implements FindInputWhereCRUDTypeDefinition{
...
@InputType()
export class LeadPotentialFindInputSortOrderDto implements FindOptionsOrder<LeadPotentialDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class LeadPotentialFindInputGroupByDto implements FindOptionsOrder<LeadPotentialDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class LeadPotentialFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<LeadPotentialDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [LeadPotentialFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<LeadPotentialFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => LeadPotentialFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: LeadPotentialFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => LeadPotentialFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<LeadPotentialFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialFindOutputRowsDto extends LeadPotentialFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class LeadPotentialFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [LeadPotentialEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: LeadPotentialEntity | LeadPotentialEntity[] | any;
}
...
export class LeadPotentialFindOneByIdDto extends LeadPotentialEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${LeadPotentialEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class LeadPotentialFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class LeadPotentialCreateDto extends LeadPotentialEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${LeadPotentialEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class LeadPotentialCreateInputDto extends  LeadPotentialCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialCreateOutputDto extends LeadPotentialFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class LeadPotentialUpdateDto extends LeadPotentialDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${LeadPotentialEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class LeadPotentialUpdateInputWhereDto extends LeadPotentialFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class LeadPotentialUpdateInputSetsDto extends PartialType(LeadPotentialCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class LeadPotentialUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [LeadPotentialUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<LeadPotentialUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => LeadPotentialUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: LeadPotentialUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialUpdateOutputAffectedRowsDto extends LeadPotentialFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [LeadPotentialEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: LeadPotentialEntity[] | any; 
}
...
export class LeadPotentialSoftDeleteDto extends LeadPotentialEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${LeadPotentialEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class LeadPotentialSoftDeleteInputWhereDto extends LeadPotentialFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class LeadPotentialSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [LeadPotentialSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadPotentialSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadPotentialDeleteDto extends LeadPotentialEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${LeadPotentialEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class LeadPotentialDeleteInputWhereDto extends LeadPotentialFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadPotentialDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [LeadPotentialDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadPotentialDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadPotentialRestoreDto extends LeadPotentialEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${LeadPotentialEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class LeadPotentialRestoreInputWhereDto extends LeadPotentialFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadPotentialRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [LeadPotentialRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadPotentialRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadPotentialUpsertDto extends LeadPotentialEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${LeadPotentialEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class LeadPotentialUpsertInputDto extends LeadPotentialCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof LeadPotentialUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialUpsertOutputDto extends IntersectionType(LeadPotentialCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class LeadPotentialSoftRemoveDto extends LeadPotentialEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${LeadPotentialEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class LeadPotentialSoftRemoveInputWhereDto extends LeadPotentialFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class LeadPotentialSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [LeadPotentialSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadPotentialSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialSoftRemoveOutputAffectedRowsDto extends LeadPotentialFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadPotentialRemoveDto extends LeadPotentialEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${LeadPotentialEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class LeadPotentialRemoveInputWhereDto extends LeadPotentialFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadPotentialRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [LeadPotentialRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadPotentialRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialRemoveOutputAffectedRowsDto extends LeadPotentialFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadPotentialRecoverDto extends LeadPotentialEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${LeadPotentialEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class LeadPotentialRecoverInputWhereDto extends LeadPotentialFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class LeadPotentialRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [LeadPotentialRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<LeadPotentialRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialRecoverOutputAffectedRowsDto extends LeadPotentialFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class LeadPotentialUploadDto extends LeadPotentialEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${LeadPotentialEntity?.metaname}${UploadArtefact}`;
...
@Field(() => LeadPotentialUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: LeadPotentialUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class LeadPotentialUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class LeadPotentialUploadDeleteDto extends LeadPotentialEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${LeadPotentialEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class LeadPotentialUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class LeadPotentialUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
