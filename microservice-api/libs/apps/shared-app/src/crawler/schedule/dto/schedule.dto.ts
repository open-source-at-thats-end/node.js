...
import { CrawlerScheduleEntityMeta as meta, CrawlerScheduleEntity } from "../entities/schedule.entity";
...
import { CrawlerScheduleUploadFileFieldEnum } from "../schedule.enum";
...
@Directive('@shareable')
export class CrawlerScheduleDto extends CrawlerScheduleEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class CrawlerScheduleFindDto extends CrawlerScheduleEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${CrawlerScheduleEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class CrawlerScheduleFindInputWhereDto extends CrawlerScheduleDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.started.desc})
    @IsOptional()
    declare started?: FindOperatorDto;

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.finished.desc})
    @IsOptional()
    declare finished?: FindOperatorDto;
...
@InputType()
export class CrawlerScheduleFindInputSortOrderDto implements FindOptionsOrder<CrawlerScheduleDto>, FindInputSortOrderCRUDTypeDefinition{
    ...
    @Field(() => RecordSortDirectionEnum, { nullable: true })
    @IsOptional()
    started?: RecordSortDirectionEnum;

    @Field(() => RecordSortDirectionEnum, { nullable: true })
    @IsOptional()
    finished?: RecordSortDirectionEnum; 
}

@InputType()
export class CrawlerScheduleFindInputGroupByDto implements FindOptionsOrder<CrawlerScheduleDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class CrawlerScheduleFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<CrawlerScheduleDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [CrawlerScheduleFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<CrawlerScheduleFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => CrawlerScheduleFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by})
    @IsOptional()
    declare groupBy?: CrawlerScheduleFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => CrawlerScheduleFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<CrawlerScheduleFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleFindOutputRowsDto extends CrawlerScheduleFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [CrawlerScheduleEntity], {description:CrudDefMetaDesc.find_rows})
    declare rows?: CrawlerScheduleEntity | CrawlerScheduleEntity[] | any;
}
...
export class CrawlerScheduleFindOneByIdDto extends CrawlerScheduleEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${CrawlerScheduleEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class CrawlerScheduleFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class CrawlerScheduleCreateDto extends CrawlerScheduleEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${CrawlerScheduleEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class CrawlerScheduleCreateInputDto extends  CrawlerScheduleCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleCreateOutputDto extends CrawlerScheduleFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class CrawlerScheduleUpdateDto extends CrawlerScheduleDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${CrawlerScheduleEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class CrawlerScheduleUpdateInputWhereDto extends CrawlerScheduleFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class CrawlerScheduleUpdateInputSetsDto extends PartialType(CrawlerScheduleCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class CrawlerScheduleUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [CrawlerScheduleUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<CrawlerScheduleUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => CrawlerScheduleUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: CrawlerScheduleUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleUpdateOutputAffectedRowsDto extends CrawlerScheduleFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [CrawlerScheduleEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: CrawlerScheduleEntity[] | any; 
}
...
export class CrawlerScheduleSoftDeleteDto extends CrawlerScheduleEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${CrawlerScheduleEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class CrawlerScheduleSoftDeleteInputWhereDto extends CrawlerScheduleFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class CrawlerScheduleSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [CrawlerScheduleSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CrawlerScheduleSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CrawlerScheduleDeleteDto extends CrawlerScheduleEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${CrawlerScheduleEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class CrawlerScheduleDeleteInputWhereDto extends CrawlerScheduleFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class CrawlerScheduleDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [CrawlerScheduleDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CrawlerScheduleDeleteInputWhereDto>[];
}

// ████ DELETE OUTPUT DTO ████████████████████████████████████████████████
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CrawlerScheduleRestoreDto extends CrawlerScheduleEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${CrawlerScheduleEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class CrawlerScheduleRestoreInputWhereDto extends CrawlerScheduleFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class CrawlerScheduleRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [CrawlerScheduleRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CrawlerScheduleRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CrawlerScheduleUpsertDto extends CrawlerScheduleEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${CrawlerScheduleEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class CrawlerScheduleUpsertInputDto extends CrawlerScheduleCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof CrawlerScheduleUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleUpsertOutputDto extends IntersectionType(CrawlerScheduleCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class CrawlerScheduleSoftRemoveDto extends CrawlerScheduleEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${CrawlerScheduleEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class CrawlerScheduleSoftRemoveInputWhereDto extends CrawlerScheduleFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class CrawlerScheduleSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [CrawlerScheduleSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CrawlerScheduleSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleSoftRemoveOutputAffectedRowsDto extends CrawlerScheduleFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CrawlerScheduleRemoveDto extends CrawlerScheduleEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${CrawlerScheduleEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class CrawlerScheduleRemoveInputWhereDto extends CrawlerScheduleFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class CrawlerScheduleRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [CrawlerScheduleRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CrawlerScheduleRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleRemoveOutputAffectedRowsDto extends CrawlerScheduleFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CrawlerScheduleRecoverDto extends CrawlerScheduleEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${CrawlerScheduleEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class CrawlerScheduleRecoverInputWhereDto extends CrawlerScheduleFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class CrawlerScheduleRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [CrawlerScheduleRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<CrawlerScheduleRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleRecoverOutputAffectedRowsDto extends CrawlerScheduleFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class CrawlerScheduleUploadDto extends CrawlerScheduleEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${CrawlerScheduleEntity?.metaname}${UploadArtefact}`;
...
@Field(() => CrawlerScheduleUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: CrawlerScheduleUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class CrawlerScheduleUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class CrawlerScheduleUploadDeleteDto extends CrawlerScheduleEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${CrawlerScheduleEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class CrawlerScheduleUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class CrawlerScheduleUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
