...
import { NewsLetterEntityMeta as meta, NewsLetterEntity } from "../entities/newsletter.entity";
...
import { NewsLetterUploadFileFieldEnum } from "../newsletter.enum";
...
import { EmailTemplateFindInputWhereDto } from "apps/shared-app/src/queue/email-template/dto/email.template.dto";
...
import { NewsLetterScheduleFindInputWhereDto } from "../../schedule/dto/schedule.dto";
...
@Directive('@shareable')
export class NewsLetterDto extends NewsLetterEntity implements FindInputDtoCRUDTypeDefinition{
     /**
     ...
     **/
     ...
     declare id?: any;
     declare etmpl_id?: any;
     declare nlcat_id?: any;
     declare title?: any;
     declare tppltf_id?: any;
     declare subject?: any;
     declare content?: any;
     declare use_default?: any;
     ...
     declare fr_email_templates?: any;
     declare fr_nl_third_party_platform?: any;
     declare fr_users?: any;
     declare fr_authorization_roles?: any;
     declare fr_nl_category?: any;
     declare fr_nl_schedule?: any;
     declare fr_nl_tracking_log?: any;
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class NewsLetterFindDto extends NewsLetterEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${NewsLetterEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class NewsLetterFindInputWhereDto extends NewsLetterDto implements FindInputWhereCRUDTypeDefinition{
  @Field(() => FindOperatorDto, {nullable: true, description: meta?.id.desc})
  @IsOptional()
  declare id?: FindOperatorDto;    

  @Field(() => FindOperatorDto, {nullable: true, description: meta?.etmpl_id.desc})
  @IsOptional()
  declare etmpl_id?: FindOperatorDto;
  ...
  @Field(() => FindOperatorDto, {nullable: true, description: meta?.use_default.desc})
  @IsOptional()
  declare use_default?: FindOperatorDto;
...
// ████ FR_ WHERE: INTERNAL RELATIONS WHERE ████████████████████████████████████████████████
   ...
   @Field(() => [EmailTemplateFindInputWhereDto], {nullable: true, description: meta?.fr_email_templates.desc})
   @IsOptional()
   declare fr_email_templates?: EmailTemplateFindInputWhereDto[];

   @Field(() => [ThirdPartyPlatformFindInputWhereDto], {nullable: true, description: meta?.fr_nl_third_party_platform.desc})
   @IsOptional()
   declare fr_nl_third_party_platform?: ThirdPartyPlatformFindInputWhereDto[];
   ...
   @Field(() => [NewsLetterCategoryFindInputWhereDto], {nullable: true, description: meta?.fr_nl_category.desc})
   @IsOptional()
   declare fr_nl_category?: NewsLetterCategoryFindInputWhereDto[]; 

   @Field(() => [NewsLetterScheduleFindInputWhereDto], {nullable: true, description: meta?.fr_nl_schedule.desc})
   @IsOptional()
   declare fr_nl_schedule?: NewsLetterScheduleFindInputWhereDto[]; 

   @Field(() => [NewsLetterScheduleFindInputWhereDto], {nullable: true, description: meta?.fr_nl_tracking_log.desc})
   @IsOptional()
   declare fr_nl_tracking_log?: NewsLetterScheduleFindInputWhereDto[]; 

   @Field(() => [NewsLetterScheduleFindInputWhereDto], {nullable: true, description: meta?.fr_nl_user.desc})
   @IsOptional()
   declare fr_nl_user?: NewsLetterScheduleFindInputWhereDto[]; 
}

@InputType()
export class NewsLetterFindInputSortOrderDto implements FindOptionsOrder<NewsLetterDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class NewsLetterFindInputGroupByDto implements FindOptionsOrder<NewsLetterDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class NewsLetterFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<NewsLetterDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [NewsLetterFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<NewsLetterFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => NewsLetterFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: NewsLetterFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => NewsLetterFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<NewsLetterFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterFindOutputRowsDto extends NewsLetterFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class NewsLetterFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [NewsLetterEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: NewsLetterEntity | NewsLetterEntity[] | any;
}
...
export class NewsLetterFindOneByIdDto extends NewsLetterEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${NewsLetterEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class NewsLetterFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class NewsLetterCreateDto extends NewsLetterEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${NewsLetterEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class NewsLetterCreateInputDto extends  NewsLetterCreateDto implements CreateInputCRUDTypeDefinition {

  @Field(() => Int, {nullable: false, description: meta?.etmpl_id.desc})
  declare etmpl_id: number;
  ...
  @Field(() => YesNoEnum, {nullable: false, description: meta?.use_default.desc})
  declare use_default: number;
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterCreateOutputDto extends NewsLetterFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class NewsLetterUpdateDto extends NewsLetterDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${NewsLetterEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class NewsLetterUpdateInputWhereDto extends NewsLetterFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class NewsLetterUpdateInputSetsDto extends PartialType(NewsLetterCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class NewsLetterUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [NewsLetterUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<NewsLetterUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => NewsLetterUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: NewsLetterUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterUpdateOutputAffectedRowsDto extends NewsLetterFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [NewsLetterEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: NewsLetterEntity[] | any; 
}
...
export class NewsLetterSoftDeleteDto extends NewsLetterEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${NewsLetterEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class NewsLetterSoftDeleteInputWhereDto extends NewsLetterFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class NewsLetterSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [NewsLetterSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<NewsLetterSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class NewsLetterDeleteDto extends NewsLetterEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${NewsLetterEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class NewsLetterDeleteInputWhereDto extends NewsLetterFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class NewsLetterDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [NewsLetterDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<NewsLetterDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class NewsLetterRestoreDto extends NewsLetterEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${NewsLetterEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class NewsLetterRestoreInputWhereDto extends NewsLetterFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class NewsLetterRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [NewsLetterRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<NewsLetterRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class NewsLetterUpsertDto extends NewsLetterEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${NewsLetterEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class NewsLetterUpsertInputDto extends NewsLetterCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof NewsLetterUpsertInputDto)[] = ['title'];
}
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterUpsertOutputDto extends IntersectionType(NewsLetterCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class NewsLetterSoftRemoveDto extends NewsLetterEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${NewsLetterEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class NewsLetterSoftRemoveInputWhereDto extends NewsLetterFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class NewsLetterSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [NewsLetterSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<NewsLetterSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterSoftRemoveOutputAffectedRowsDto extends NewsLetterFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class NewsLetterRemoveDto extends NewsLetterEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${NewsLetterEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class NewsLetterRemoveInputWhereDto extends NewsLetterFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class NewsLetterRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [NewsLetterRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<NewsLetterRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterRemoveOutputAffectedRowsDto extends NewsLetterFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class NewsLetterRecoverDto extends NewsLetterEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${NewsLetterEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class NewsLetterRecoverInputWhereDto extends NewsLetterFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class NewsLetterRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [NewsLetterRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<NewsLetterRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterRecoverOutputAffectedRowsDto extends NewsLetterFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class NewsLetterUploadDto extends NewsLetterEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${NewsLetterEntity?.metaname}${UploadArtefact}`;
...
@Field(() => NewsLetterUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: NewsLetterUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class NewsLetterUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class NewsLetterUploadDeleteDto extends NewsLetterEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${NewsLetterEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class NewsLetterUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class NewsLetterUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
