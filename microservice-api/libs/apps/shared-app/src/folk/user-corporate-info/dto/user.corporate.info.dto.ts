...
import { UserCorporateInfoEntityMeta as meta, UserCorporateInfoEntity } from "../entities/user.corporate.info.entity";
...
import { UserCorporateInfoUploadFileFieldEnum } from "../user.corporate.info.enum";
...
@Directive('@shareable')
export class UserCorporateInfoDto extends UserCorporateInfoEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class UserCorporateInfoFindDto extends UserCorporateInfoEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${UserCorporateInfoEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class UserCorporateInfoFindInputWhereDto extends UserCorporateInfoDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.company_name.desc})
    @IsOptional()
    declare company_name?: FindOperatorDto;

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.contact_person_name.desc})
    @IsOptional()
    declare contact_person_name?: FindOperatorDto;
...
@InputType()
export class UserCorporateInfoFindInputSortOrderDto implements FindOptionsOrder<UserCorporateInfoDto>, FindInputSortOrderCRUDTypeDefinition{
    ...
    @Field(() => RecordSortDirectionEnum, {nullable: true, description: meta?.city_id.desc})
    @IsOptional()
    city_id?: RecordSortDirectionEnum;

    @Field(() => RecordSortDirectionEnum, {nullable: true, description: meta?.state_id.desc})
    @IsOptional()
...
@InputType()
export class UserCorporateInfoFindInputGroupByDto implements FindOptionsOrder<UserCorporateInfoDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class UserCorporateInfoFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<UserCorporateInfoDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [UserCorporateInfoFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<UserCorporateInfoFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => UserCorporateInfoFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: UserCorporateInfoFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => UserCorporateInfoFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<UserCorporateInfoFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoFindOutputRowsDto extends UserCorporateInfoFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [UserCorporateInfoEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: UserCorporateInfoEntity | UserCorporateInfoEntity[] | any;
}
...
export class UserCorporateInfoFindOneByIdDto extends UserCorporateInfoEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${UserCorporateInfoEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class UserCorporateInfoFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class UserCorporateInfoCreateDto extends UserCorporateInfoEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${UserCorporateInfoEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class UserCorporateInfoCreateInputDto extends  UserCorporateInfoCreateDto implements CreateInputCRUDTypeDefinition {

    @Field(() => Int, {nullable: false, description: meta?.u_id.desc})
    declare u_id?: number;

    @Field(() => String, {nullable: false, description: meta?.company_name.desc})
    ...
    @Field(() => String, {nullable: false, description: meta?.mobile.desc})
    declare mobile?: string;

    @Field(() => String, {nullable: false, description: meta?.mobile_cc.desc})
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoCreateOutputDto extends UserCorporateInfoFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class UserCorporateInfoUpdateDto extends UserCorporateInfoDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${UserCorporateInfoEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class UserCorporateInfoUpdateInputWhereDto extends UserCorporateInfoFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class UserCorporateInfoUpdateInputSetsDto extends PartialType(UserCorporateInfoCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class UserCorporateInfoUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [UserCorporateInfoUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<UserCorporateInfoUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => UserCorporateInfoUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: UserCorporateInfoUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoUpdateOutputAffectedRowsDto extends UserCorporateInfoFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [UserCorporateInfoEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: UserCorporateInfoEntity[] | any; 
}
...
export class UserCorporateInfoSoftDeleteDto extends UserCorporateInfoEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${UserCorporateInfoEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class UserCorporateInfoSoftDeleteInputWhereDto extends UserCorporateInfoFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class UserCorporateInfoSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [UserCorporateInfoSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserCorporateInfoSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserCorporateInfoDeleteDto extends UserCorporateInfoEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${UserCorporateInfoEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class UserCorporateInfoDeleteInputWhereDto extends UserCorporateInfoFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class UserCorporateInfoDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [UserCorporateInfoDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserCorporateInfoDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserCorporateInfoRestoreDto extends UserCorporateInfoEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${UserCorporateInfoEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class UserCorporateInfoRestoreInputWhereDto extends UserCorporateInfoFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class UserCorporateInfoRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [UserCorporateInfoRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserCorporateInfoRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserCorporateInfoUpsertDto extends UserCorporateInfoEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${UserCorporateInfoEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class UserCorporateInfoUpsertInputDto extends UserCorporateInfoCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof UserCorporateInfoUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoUpsertOutputDto extends IntersectionType(UserCorporateInfoCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class UserCorporateInfoSoftRemoveDto extends UserCorporateInfoEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${UserCorporateInfoEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class UserCorporateInfoSoftRemoveInputWhereDto extends UserCorporateInfoFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class UserCorporateInfoSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [UserCorporateInfoSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserCorporateInfoSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoSoftRemoveOutputAffectedRowsDto extends UserCorporateInfoFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserCorporateInfoRemoveDto extends UserCorporateInfoEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${UserCorporateInfoEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class UserCorporateInfoRemoveInputWhereDto extends UserCorporateInfoFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class UserCorporateInfoRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [UserCorporateInfoRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserCorporateInfoRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoRemoveOutputAffectedRowsDto extends UserCorporateInfoFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserCorporateInfoRecoverDto extends UserCorporateInfoEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${UserCorporateInfoEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class UserCorporateInfoRecoverInputWhereDto extends UserCorporateInfoFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class UserCorporateInfoRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [UserCorporateInfoRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserCorporateInfoRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoRecoverOutputAffectedRowsDto extends UserCorporateInfoFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserCorporateInfoUploadDto extends UserCorporateInfoEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${UserCorporateInfoEntity?.metaname}${UploadArtefact}`;
...
@Field(() => UserCorporateInfoUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class UserCorporateInfoUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class UserCorporateInfoUploadDeleteDto extends UserCorporateInfoEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${UserCorporateInfoEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class UserCorporateInfoUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class UserCorporateInfoUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
