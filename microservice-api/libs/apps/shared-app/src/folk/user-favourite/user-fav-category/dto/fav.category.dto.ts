...
import { UserFavCategoryEntityMeta as meta, UserFavCategoryEntity } from "../entities/fav.category.entity";
...
import { UserFavCategoryUploadFileFieldEnum } from "../fav.category.enum";
import { UserFavFindInputWhereDto } from "../../user-fav/dto/user.fav.dto";
...
@Directive('@shareable')
export class UserFavCategoryDto extends UserFavCategoryEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class UserFavCategoryFindDto extends UserFavCategoryEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${UserFavCategoryEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class UserFavCategoryFindInputWhereDto extends UserFavCategoryDto implements FindInputWhereCRUDTypeDefinition{
  ...
  @Field(() => [UserFavFindInputWhereDto], {nullable: true, description: meta?.fr_user_favourite.desc})
  @IsOptional()
  declare fr_user_favourite?: UserFavFindInputWhereDto[];
}

@InputType()
export class UserFavCategoryFindInputSortOrderDto implements FindOptionsOrder<UserFavCategoryDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class UserFavCategoryFindInputGroupByDto implements FindOptionsOrder<UserFavCategoryDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class UserFavCategoryFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<UserFavCategoryDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [UserFavCategoryFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<UserFavCategoryFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => UserFavCategoryFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: UserFavCategoryFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => UserFavCategoryFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<UserFavCategoryFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryFindOutputRowsDto extends UserFavCategoryFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class UserFavCategoryFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [UserFavCategoryEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: UserFavCategoryEntity | UserFavCategoryEntity[] | any;
}
...
export class UserFavCategoryFindOneByIdDto extends UserFavCategoryEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${UserFavCategoryEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class UserFavCategoryFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class UserFavCategoryCreateDto extends UserFavCategoryEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${UserFavCategoryEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class UserFavCategoryCreateInputDto extends  UserFavCategoryCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryCreateOutputDto extends UserFavCategoryFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class UserFavCategoryUpdateDto extends UserFavCategoryDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${UserFavCategoryEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class UserFavCategoryUpdateInputWhereDto extends UserFavCategoryFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class UserFavCategoryUpdateInputSetsDto extends PartialType(UserFavCategoryCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class UserFavCategoryUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [UserFavCategoryUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<UserFavCategoryUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => UserFavCategoryUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: UserFavCategoryUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryUpdateOutputAffectedRowsDto extends UserFavCategoryFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [UserFavCategoryEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: UserFavCategoryEntity[] | any; 
}
...
export class UserFavCategorySoftDeleteDto extends UserFavCategoryEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${UserFavCategoryEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class UserFavCategorySoftDeleteInputWhereDto extends UserFavCategoryFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class UserFavCategorySoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [UserFavCategorySoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserFavCategorySoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategorySoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserFavCategoryDeleteDto extends UserFavCategoryEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${UserFavCategoryEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class UserFavCategoryDeleteInputWhereDto extends UserFavCategoryFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class UserFavCategoryDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [UserFavCategoryDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserFavCategoryDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserFavCategoryRestoreDto extends UserFavCategoryEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${UserFavCategoryEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class UserFavCategoryRestoreInputWhereDto extends UserFavCategoryFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class UserFavCategoryRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [UserFavCategoryRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserFavCategoryRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserFavCategoryUpsertDto extends UserFavCategoryEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${UserFavCategoryEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class UserFavCategoryUpsertInputDto extends UserFavCategoryCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof UserFavCategoryUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryUpsertOutputDto extends IntersectionType(UserFavCategoryCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class UserFavCategorySoftRemoveDto extends UserFavCategoryEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${UserFavCategoryEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class UserFavCategorySoftRemoveInputWhereDto extends UserFavCategoryFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class UserFavCategorySoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [UserFavCategorySoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserFavCategorySoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategorySoftRemoveOutputAffectedRowsDto extends UserFavCategoryFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategorySoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserFavCategoryRemoveDto extends UserFavCategoryEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${UserFavCategoryEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class UserFavCategoryRemoveInputWhereDto extends UserFavCategoryFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class UserFavCategoryRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [UserFavCategoryRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserFavCategoryRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryRemoveOutputAffectedRowsDto extends UserFavCategoryFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserFavCategoryRecoverDto extends UserFavCategoryEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${UserFavCategoryEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class UserFavCategoryRecoverInputWhereDto extends UserFavCategoryFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class UserFavCategoryRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [UserFavCategoryRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserFavCategoryRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryRecoverOutputAffectedRowsDto extends UserFavCategoryFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserFavCategoryUploadDto extends UserFavCategoryEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${UserFavCategoryEntity?.metaname}${UploadArtefact}`;
...
@Field(() => UserFavCategoryUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: UserFavCategoryUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class UserFavCategoryUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class UserFavCategoryUploadDeleteDto extends UserFavCategoryEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${UserFavCategoryEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class UserFavCategoryUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class UserFavCategoryUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
