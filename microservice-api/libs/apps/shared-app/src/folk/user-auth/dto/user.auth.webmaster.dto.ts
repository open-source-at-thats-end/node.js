...
import { UserAuthenticationUploadFileFieldEnum } from "../user.auth.enum";
...
@Directive('@shareable')
export class UserAuthenticationDto extends UserAuthenticationEntity implements FindInputDtoCRUDTypeDefinition{
     /**
     ...
     **/
     declare id?: any;
     declare identify?: any;
     declare identify_last?: any;
     declare last_changed?: any;
     declare force_reset?: any;
     declare otp?: any;
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class UserAuthenticationFindDto extends UserAuthenticationEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationFindInputWhereDto extends UserAuthenticationDto implements FindInputWhereCRUDTypeDefinition {
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.id.desc})
    @IsOptional()
    declare id?: FindOperatorDto;    

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.last_changed.desc})
    @IsOptional()
    declare last_changed?: FindOperatorDto;

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.force_reset.desc})
    @IsOptional()
    ...
    @Field(() => [SessionFindInputWhereDto], {nullable: true, description: meta?.fr_user_sessions.desc})    
    @IsOptional()    
    declare fr_user_sessions?: SessionFindInputWhereDto[];
...
@InputType()
export class UserAuthenticationFindInputSortOrderDto implements FindOptionsOrder<UserAuthenticationDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationFindInputGroupByDto implements FindOptionsOrder<UserAuthenticationDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<UserAuthenticationDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [UserAuthenticationFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<UserAuthenticationFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => UserAuthenticationFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
     ...
     */
    @Field(() => UserAuthenticationFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<UserAuthenticationFindInputSortOrderDto>;
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationFindOutputRowsDto extends UserAuthenticationFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class UserAuthenticationFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [UserAuthenticationEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: UserAuthenticationEntity | UserAuthenticationEntity[] | any;
}
...
export class UserAuthenticationFindOneByIdDto extends UserAuthenticationEntity implements FindDtoCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class UserAuthenticationCreateDto extends UserAuthenticationEntity implements CreateDtoCRUDTypeDefinition {
...
@InputType()
export class UserAuthenticationCreateInputDto extends UserAuthenticationCreateDto implements CreateInputCRUDTypeDefinition {
    @Field(() => Int, { nullable: false, description: meta?.id.desc })
    declare id: number;

    @Field(() => String, { nullable: true, description: `${meta.identify.desc} ${meta.identify.validation?.matchRegExMsg}`})
    declare identify: string;

    @Field(() => String, { nullable: true, description: meta?.identify_confirm.desc })
    @IsSameAs<UserAuthenticationEntity>('identify', { message: meta?.identify_confirm.validation?.isSameAs })
    declare identify_confirm: string;

    @Field(() => DateTime, { nullable: true, defaultValue: YesNoEnum.NO, description: meta?.force_reset.desc })
    declare force_reset?: Date;
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationCreateOutputDto extends UserAuthenticationFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class UserAuthenticationUpdateDto extends UserAuthenticationDto implements UpdateDtoCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationUpdateInputWhereDto extends UserAuthenticationFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class UserAuthenticationUpdateInputSetsDto extends PartialType(UserAuthenticationCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class UserAuthenticationUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [UserAuthenticationUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<UserAuthenticationUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => UserAuthenticationUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: UserAuthenticationUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationUpdateOutputAffectedRowsDto extends UserAuthenticationFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [UserAuthenticationUpdateOutputAffectedRowsDto], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: UserAuthenticationUpdateOutputAffectedRowsDto[] | any; 
}
...
export class UserAuthenticationSoftDeleteDto extends UserAuthenticationEntity implements SoftDeleteDtoCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationSoftDeleteInputWhereDto extends UserAuthenticationFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class UserAuthenticationSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [UserAuthenticationSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserAuthenticationSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserAuthenticationDeleteDto extends UserAuthenticationEntity implements DeleteDtoCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationDeleteInputWhereDto extends UserAuthenticationFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class UserAuthenticationDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [UserAuthenticationDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserAuthenticationDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserAuthenticationRestoreDto extends UserAuthenticationEntity implements RestoreDtoCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationRestoreInputWhereDto extends UserAuthenticationFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class UserAuthenticationRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [UserAuthenticationRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserAuthenticationRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class UserAuthenticationUpsertDto extends UserAuthenticationEntity implements UpsertDtoCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationUpsertInputDto extends UserAuthenticationCreateInputDto implements UpsertInputCRUDTypeDefinition{
    /**
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof UserAuthenticationUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationUpsertOutputDto extends IntersectionType(UserAuthenticationCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class UserAuthenticationSoftRemoveDto extends UserAuthenticationEntity implements SoftRemoveDtoCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationSoftRemoveInputWhereDto extends UserAuthenticationFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class UserAuthenticationSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [UserAuthenticationSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserAuthenticationSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationSoftRemoveOutputAffectedRowsDto extends UserAuthenticationFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [UserAuthenticationSoftRemoveOutputAffectedRowsDto]) 
  declare affectedRows?: UserAuthenticationSoftRemoveOutputAffectedRowsDto[] | any
}
...
export class UserAuthenticationRemoveDto extends UserAuthenticationEntity implements RemoveDtoCRUDTypeDefinition{
...
// ████ REMOVE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class UserAuthenticationRemoveInputWhereDto extends UserAuthenticationFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class UserAuthenticationRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [UserAuthenticationRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserAuthenticationRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationRemoveOutputAffectedRowsDto extends UserAuthenticationFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [UserAuthenticationRemoveOutputAffectedRowsDto]) 
  declare affectedRows?: UserAuthenticationRemoveOutputAffectedRowsDto[] | any;
}
...
export class UserAuthenticationRecoverDto extends UserAuthenticationEntity implements RecoverDtoCRUDTypeDefinition{
...
@InputType()
export class UserAuthenticationRecoverInputWhereDto extends UserAuthenticationFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class UserAuthenticationRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [UserAuthenticationRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<UserAuthenticationRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationRecoverOutputAffectedRowsDto extends UserAuthenticationFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
  ...
  @Field(() => [UserAuthenticationRecoverOutputAffectedRowsDto]) 
  declare affectedRows?: UserAuthenticationRecoverOutputAffectedRowsDto[] | any;
}
...
export class UserAuthenticationUploadDto extends UserAuthenticationEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${UserAuthenticationEntity?.metaname}${UploadArtefact}`;
...
@Field(() => UserAuthenticationUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: UserAuthenticationUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class UserAuthenticationUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class UserAuthenticationUploadDeleteDto extends UserAuthenticationEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${UserAuthenticationEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class UserAuthenticationUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class UserAuthenticationUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
