...
import { QueueTypeEntityMeta as meta, QueueTypeEntity } from "../entities/type.entity";
...
import { QueueTypeUploadFileFieldEnum } from "../type.enum";
import { QueueSmsFindInputWhereDto } from "../../sms/dto/sms.dto";
import { QueueWhatsappFindInputWhereDto } from "../../whatsapp/dto/whatsapp.dto";
import { QueueEmailFindInputWhereDto } from "../../email/dto/email.dto";
...
@Directive('@shareable')
export class QueueTypeDto extends QueueTypeEntity implements FindInputDtoCRUDTypeDefinition{
     /**
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class QueueTypeFindDto extends QueueTypeEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${QueueTypeEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class QueueTypeFindInputWhereDto extends QueueTypeDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => [QueueEmailFindInputWhereDto], {nullable: true, description: meta?.fr_queue_email.desc})
    @IsOptional()
    declare fr_queue_email?: QueueEmailFindInputWhereDto[];
}

@InputType()
export class QueueTypeFindInputSortOrderDto implements FindOptionsOrder<QueueTypeDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class QueueTypeFindInputGroupByDto implements FindOptionsOrder<QueueTypeDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class QueueTypeFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<QueueTypeDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [QueueTypeFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<QueueTypeFindInputWhereDto>[];
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => QueueTypeFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: QueueTypeFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => QueueTypeFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<QueueTypeFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeFindOutputRowsDto extends QueueTypeFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class QueueTypeFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [QueueTypeEntity], {description: CrudDefMetaDesc.find_rows})
    declare rows?: QueueTypeEntity | QueueTypeEntity[] | any;
}
...
export class QueueTypeFindOneByIdDto extends QueueTypeEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${QueueTypeEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class QueueTypeFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class QueueTypeCreateDto extends QueueTypeEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${QueueTypeEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class QueueTypeCreateInputDto extends  QueueTypeCreateDto implements CreateInputCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeCreateOutputDto extends QueueTypeFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class QueueTypeUpdateDto extends QueueTypeDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${QueueTypeEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class QueueTypeUpdateInputWhereDto extends QueueTypeFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class QueueTypeUpdateInputSetsDto extends PartialType(QueueTypeCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class QueueTypeUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [QueueTypeUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<QueueTypeUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => QueueTypeUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: QueueTypeUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeUpdateOutputAffectedRowsDto extends QueueTypeFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [QueueTypeEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: QueueTypeEntity[] | any; 
}
...
export class QueueTypeSoftDeleteDto extends QueueTypeEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${QueueTypeEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class QueueTypeSoftDeleteInputWhereDto extends QueueTypeFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class QueueTypeSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [QueueTypeSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<QueueTypeSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class QueueTypeDeleteDto extends QueueTypeEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${QueueTypeEntity.metaname}${DeleteArtefact}`;
...
@InputType()
export class QueueTypeDeleteInputWhereDto extends QueueTypeFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class QueueTypeDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [QueueTypeDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<QueueTypeDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class QueueTypeRestoreDto extends QueueTypeEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${QueueTypeEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class QueueTypeRestoreInputWhereDto extends QueueTypeFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class QueueTypeRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [QueueTypeRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<QueueTypeRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class QueueTypeUpsertDto extends QueueTypeEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${QueueTypeEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class QueueTypeUpsertInputDto extends QueueTypeCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof QueueTypeUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeUpsertOutputDto extends IntersectionType(QueueTypeCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class QueueTypeSoftRemoveDto extends QueueTypeEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${QueueTypeEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class QueueTypeSoftRemoveInputWhereDto extends QueueTypeFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class QueueTypeSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [QueueTypeSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<QueueTypeSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeSoftRemoveOutputAffectedRowsDto extends QueueTypeFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class QueueTypeRemoveDto extends QueueTypeEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${QueueTypeEntity.metaname}${RemoveArtefact}`;
...
@InputType()
export class QueueTypeRemoveInputWhereDto extends QueueTypeFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class QueueTypeRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [QueueTypeRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<QueueTypeRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeRemoveOutputAffectedRowsDto extends QueueTypeFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class QueueTypeRecoverDto extends QueueTypeEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${QueueTypeEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class QueueTypeRecoverInputWhereDto extends QueueTypeFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class QueueTypeRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [QueueTypeRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<QueueTypeRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeRecoverOutputAffectedRowsDto extends QueueTypeFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class QueueTypeUploadDto extends QueueTypeEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${QueueTypeEntity?.metaname}${UploadArtefact}`;
...
@Field(() => QueueTypeUploadFileFieldEnum, {nullable: false, description: CrudDefMetaDesc.upload_file_field})
@IsNotEmpty()
file_field!: QueueTypeUploadFileFieldEnum;
}
...
// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class QueueTypeUploadInputDto extends IntersectionType(UploadFileFieldInputDto, UploadInputDto) implements UploadInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeUploadOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadOutputDto) implements UploadOutputArtefactCRUDTypeDefinition {
...
export class QueueTypeUploadDeleteDto extends QueueTypeEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${QueueTypeEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class QueueTypeUploadDeleteInputDto extends IntersectionType(UploadFileFieldInputDto, UploadDeleteInputDto) implements UploadDeleteInputArtefactCRUDTypeDefinition {
...
@ObjectType()
@Directive('@shareable')
export class QueueTypeUploadDeleteOutputDto extends IntersectionType(UploadFileFieldOutputDto, UploadDeleteOutputDto) implements UploadDeleteOutputArtefactCRUDTypeDefinition {
