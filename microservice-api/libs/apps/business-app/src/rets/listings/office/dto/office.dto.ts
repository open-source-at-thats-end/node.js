...
import { RetsListingOfficeEntityMeta as meta, RetsListingOfficeEntity } from "../entities/office.entity";
...
import { RetsListingOfficeUploadRefTypeEnum } from "../office.enum";
...
/**
 * # [done] ['../entities/listing.office.entity', './dto/listing.office.dto'] . Hint: find [ /listing.office. => and replace with ] [ /your-module. ] 
 * # [done] do not break some dependences which required this class
 * # [done] module [RetsListingOffice]
...
@Directive('@shareable')
export class RetsListingOfficeDto extends RetsListingOfficeEntity implements FindInputDtoCRUDTypeDefinition{
     /**
    ...
    declare office_email?: any;
    declare office_phone?: any;
    declare office_last_updated_date?: any;
    declare created?: any;
    declare updated?: any;
    declare deleted?: any;
...
@ObjectType({ isAbstract: true })
@Directive('@shareable')
export class RetsListingOfficeFindDto extends RetsListingOfficeEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${RetsListingOfficeEntity?.metaname}${FindArtefact}`;
...
@InputType()
export class RetsListingOfficeFindInputWhereDto extends RetsListingOfficeDto implements FindInputWhereCRUDTypeDefinition{
    ...
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.office_email.desc})        
    @IsOptional()
    declare office_email?: FindOperatorDto;

    @Field(() => FindOperatorDto, {nullable: true, description: meta?.office_phone.desc})        
    @IsOptional()
    declare office_phone?: FindOperatorDto;
    
    @Field(() => FindOperatorDto, {nullable: true, description: meta?.office_last_updated_date.desc})        
    @IsOptional()
    declare office_last_updated_date?: FindOperatorDto;
...
@InputType()
export class RetsListingOfficeFindInputSortOrderDto implements FindOptionsOrder<RetsListingOfficeDto>, FindInputSortOrderCRUDTypeDefinition{
...
@InputType()
export class RetsListingOfficeFindInputGroupByDto implements FindOptionsOrder<RetsListingOfficeDto>, FindInputGroupByCRUDTypeDefinition{
...
@InputType()
export class RetsListingOfficeFindInputDto extends IntersectionType(FindInputPaginationOptionsDto, WithDeletedInputDto) implements FindManyOptions<RetsListingOfficeDto>, FindInputCRUDTypeDefinition{
     ...
     */
    @Field(() => [RetsListingOfficeFindInputWhereDto], { nullable: true, description: CrudDefMetaDesc.find_where })
    @IsOptional()
    @Validate(OnlyOneSeachOperatorAllowed)
    declare where?: FindOptionsWhere<RetsListingOfficeFindInputWhereDto>;
  
  
    /**
     * Specifies how to group the rows returned by the SELECT statement.
     */
    @Field(() => RetsListingOfficeFindInputGroupByDto, { nullable: true, description: CrudDefMetaDesc.find_group_by })
    @IsOptional()
    declare groupBy?: RetsListingOfficeFindInputGroupByDto;
  
    /**
     * Sort the result set by fields using ascending or descending order.
     */
    @Field(() => RetsListingOfficeFindInputSortOrderDto, { nullable: true, description: CrudDefMetaDesc.find_order })
    @IsOptional()
    declare order?: FindOptionsOrder<RetsListingOfficeFindInputSortOrderDto>;
}
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeFindOutputRowsDto extends RetsListingOfficeFindDto implements FindOutputRowsCRUDTypeDefinition{
    // this DTO will be used at many palce for output object, os make sure this is properly developed
}

@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeFindOutputDto extends FindOutputPaginationOptionsDto implements FindOutputCRUDTypeDefinition{
    ...
    @Field(() => [RetsListingOfficeEntity], {description:CrudDefMetaDesc.find_rows})
    declare rows?: RetsListingOfficeEntity | RetsListingOfficeEntity[] | any;
}
...
export class RetsListingOfficeFindOneByIdDto extends RetsListingOfficeEntity implements FindDtoCRUDTypeDefinition{
    static metaname: string = `${RetsListingOfficeEntity.metaname}${FindOneByIdArtefact}`;
...
@InputType()
export class RetsListingOfficeFindOneByIdInputDto extends IntersectionType(IdInputDto, WithDeletedInputDto) implements FindOneByIdInputCRUDTypeDefinition{
...
export class RetsListingOfficeCreateDto extends RetsListingOfficeEntity implements CreateDtoCRUDTypeDefinition {
    static metaname: string = `${RetsListingOfficeEntity.metaname}${CreateArtefact}`;
    static metadesc: string = CrudDefMetaDesc.create_metadesc;
}
// ████ CREATE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class RetsListingOfficeCreateInputDto extends  RetsListingOfficeCreateDto implements CreateInputCRUDTypeDefinition {
    ...
    @Field(() => String, {nullable: false, description: meta?.office_name.desc})  
    declare office_name?: string;
    
    @Field(() => String, {nullable: true, description: meta?.office_email.desc})  
    declare office_email?: string;
    ...
    declare office_last_updated_date?: Date;
}
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeCreateOutputDto extends RetsListingOfficeFindOutputRowsDto implements CreateOutputCRUDTypeDefinition {
    /**
...
export class RetsListingOfficeUpdateDto extends RetsListingOfficeDto implements UpdateDtoCRUDTypeDefinition{
    static metaname: string = `${RetsListingOfficeEntity.metaname}${UpdateArtefact}`;
...
@InputType()
export class RetsListingOfficeUpdateInputWhereDto extends RetsListingOfficeFindInputWhereDto implements UpdateInputWhereCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@InputType()
export class RetsListingOfficeUpdateInputSetsDto extends PartialType(RetsListingOfficeCreateInputDto) implements UpdateInputSetsCRUDTypeDefinition {
    /**
...
@InputType()
export class RetsListingOfficeUpdateInputDto implements UpdateInputCRUDTypeDefinition{
     ...
     * also validate the user pass only 1 operator to search for field
     */
    @Field(() => [RetsListingOfficeUpdateInputWhereDto], { nullable: false, description: CrudDefMetaDesc.update_where })
    @IsNotEmpty()
    @Validate(OnlyOneSeachOperatorAllowed)
    where!: FindOptionsWhere<RetsListingOfficeUpdateInputWhereDto>[];

    /**
     * What to set for update
     * basically fields list of update
     */
    @Field(() => RetsListingOfficeUpdateInputSetsDto, { nullable: false, description: CrudDefMetaDesc.update_sets })
    @IsNotEmpty()
    sets!: RetsListingOfficeUpdateInputSetsDto
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeUpdateOutputAffectedRowsDto extends RetsListingOfficeFindOutputRowsDto implements UpdateOutputAffectedRowsCRUDTypeDefinition{
    /**
     * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeUpdateOutputDto extends CrudAffectedDto implements UpdateOutputCRUDTypeDefinition{
  @Field(() => [RetsListingOfficeEntity], {description: CrudDefMetaDesc.update_affected_rows}) 
  declare affectedRows?: RetsListingOfficeEntity[] | any; 
}
...
export class RetsListingOfficeSoftDeleteDto extends RetsListingOfficeEntity implements SoftDeleteDtoCRUDTypeDefinition{
  static metaname: string = `${RetsListingOfficeEntity.metaname}${SoftDeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softDelete_metadesc;
}

@InputType()
export class RetsListingOfficeSoftDeleteInputWhereDto extends RetsListingOfficeFindInputWhereDto implements SoftDeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class RetsListingOfficeSoftDeleteInputDto implements SoftDeleteInputCRUDTypeDefinition{
  @Field(() => [RetsListingOfficeSoftDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softDelete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RetsListingOfficeSoftDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeSoftDeleteOutputDto extends CrudAffectedDto implements SoftDeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RetsListingOfficeDeleteDto extends RetsListingOfficeEntity implements DeleteDtoCRUDTypeDefinition{
  static metaname: string = `${RetsListingOfficeEntity.metaname}${DeleteArtefact}`;
  static metadesc: string = CrudDefMetaDesc.delete_metadesc;
}
// ████ DELETE INPUT DTO ████████████████████████████████████████████████

@InputType()
export class RetsListingOfficeDeleteInputWhereDto extends RetsListingOfficeFindInputWhereDto implements DeleteInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class RetsListingOfficeDeleteInputDto implements DeleteInputCRUDTypeDefinition{
  @Field(() => [RetsListingOfficeDeleteInputWhereDto], {nullable: true, description: CrudDefMetaDesc.delete_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RetsListingOfficeDeleteInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeDeleteOutputDto extends CrudAffectedDto implements DeleteOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RetsListingOfficeRestoreDto extends RetsListingOfficeEntity implements RestoreDtoCRUDTypeDefinition{
    static metaname: string = `${RetsListingOfficeEntity.metaname}${RestoreArtefact}`;
...
@InputType()
export class RetsListingOfficeRestoreInputWhereDto extends RetsListingOfficeFindInputWhereDto implements RestoreInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
   * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class RetsListingOfficeRestoreInputDto implements RestoreInputCRUDTypeDefinition{
  @Field(() => [RetsListingOfficeRestoreInputWhereDto], {nullable: true, description: CrudDefMetaDesc.restore_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RetsListingOfficeRestoreInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeRestoreOutputDto extends CrudAffectedDto implements RestoreOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RetsListingOfficeUpsertDto extends RetsListingOfficeEntity implements UpsertDtoCRUDTypeDefinition{
  static metaname: string = `${RetsListingOfficeEntity.metaname}${UpsertArtefact}`;
...
@InputType()
export class RetsListingOfficeUpsertInputDto extends RetsListingOfficeCreateInputDto implements UpsertInputCRUDTypeDefinition{
     ...
     **/
    @Exclude()
    static conflictResolveFields: (keyof RetsListingOfficeUpsertInputDto)[] = ['id'];
}
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeUpsertOutputDto extends IntersectionType(RetsListingOfficeCreateOutputDto, UpsertOutputProcessStatusDto) implements UpsertOutputCRUDTypeDefinition{ 
...
export class RetsListingOfficeSoftRemoveDto extends RetsListingOfficeEntity implements SoftRemoveDtoCRUDTypeDefinition{
  static metaname: string = `${RetsListingOfficeEntity.metaname}${SoftRemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.softRemove_metadesc;
}

@InputType()
export class RetsListingOfficeSoftRemoveInputWhereDto extends RetsListingOfficeFindInputWhereDto implements SoftRemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@InputType()
export class RetsListingOfficeSoftRemoveInputDto implements SoftRemoveInputCRUDTypeDefinition{
  @Field(() => [RetsListingOfficeSoftRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.softRemove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RetsListingOfficeSoftRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeSoftRemoveOutputAffectedRowsDto extends RetsListingOfficeFindOutputRowsDto implements SoftRemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeSoftRemoveOutputDto extends CrudAffectedDto implements SoftRemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RetsListingOfficeRemoveDto extends RetsListingOfficeEntity implements RemoveDtoCRUDTypeDefinition{
  static metaname: string = `${RetsListingOfficeEntity.metaname}${RemoveArtefact}`;
  static metadesc: string = CrudDefMetaDesc.remove_metadesc;
}

// ████ REMOVE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class RetsListingOfficeRemoveInputWhereDto extends RetsListingOfficeFindInputWhereDto implements RemoveInputWhereCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindInputWhere ask for input, same apply to SoftRemoveInputWhere so extending class
   * just add what is new or different for SoftRemoveInputWhere, that means it's 100% customisable
...
@InputType()
export class RetsListingOfficeRemoveInputDto implements RemoveInputCRUDTypeDefinition{
  @Field(() => [RetsListingOfficeRemoveInputWhereDto], {nullable: true, description: CrudDefMetaDesc.remove_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RetsListingOfficeRemoveInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeRemoveOutputAffectedRowsDto extends RetsListingOfficeFindOutputRowsDto implements RemoveOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever FindOutputRows return, same apply to SoftRemoveOutputAffectedRows so extending class
   * just add what is new or different for SoftRemoveOutputAffectedRows, that means it's 100% customisable
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeRemoveOutputDto extends CrudAffectedDto implements RemoveOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
   * considering whatever AffectedDto return, same apply to SoftRemoveOutput so extending class
   * just add what is new or different for SoftRemoveOutput, that means it's 100% customisable
...
export class RetsListingOfficeRecoverDto extends RetsListingOfficeEntity implements RecoverDtoCRUDTypeDefinition{
  static metaname: string = `${RetsListingOfficeEntity.metaname}${RecoverArtefact}`;
...
@InputType()
export class RetsListingOfficeRecoverInputWhereDto extends RetsListingOfficeFindInputWhereDto implements RecoverInputWhereCRUDTypeDefinition{
/**
 * avoiding redundant code
 * considering whatever FindInputWhere ask for input, same apply to SoftDeleteInputWhere so extending class
 * just add what is new or different for SoftDeleteInputWhere, that means it's 100% customisable
...
@InputType()
export class RetsListingOfficeRecoverInputDto implements RecoverInputCRUDTypeDefinition{
  @Field(() => [RetsListingOfficeRecoverInputWhereDto], {nullable: true, description: CrudDefMetaDesc.recover_where})
  @Validate(OnlyOneSeachOperatorAllowed)
  where?: FindOptionsWhere<RetsListingOfficeRecoverInputWhereDto>[];
}
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeRecoverOutputAffectedRowsDto extends RetsListingOfficeFindOutputRowsDto implements RecoverOutputAffectedRowsCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeRecoverOutputDto extends CrudAffectedDto implements RecoverOutputCRUDTypeDefinition{
  /**
   * avoiding redundant code
...
export class RetsListingOfficeUploadDto extends RetsListingOfficeEntity implements UploadDtoCRUDTypeDefinition {
  static metaname: string = `${RetsListingOfficeEntity?.metaname}${UploadArtefact}`;
  static metadesc: string = CrudDefMetaDesc.upload_metadesc;
}

// ████ UPLOAD INPUT DTO ████████████████████████████████████████████████
@InputType()
export class RetsListingOfficeUploadInputDto extends UploadInputDto implements UploadInputArtefactCRUDTypeDefinition {
@Field(() => RetsListingOfficeUploadRefTypeEnum, {nullable: false, description: CrudDefMetaDesc.upload_ref_type})
@IsNotEmpty()
ref_type!: RetsListingOfficeUploadRefTypeEnum;
}

// ████ UPLOAD OUTPUT DTO ███████████████████████████████████████████████
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeUploadOutputDto extends UploadOutputDto implements UploadOutputArtefactCRUDTypeDefinition {
@Field(() => RetsListingOfficeUploadRefTypeEnum, {nullable: true, description: CrudDefMetaDesc.upload_ref_type})
ref_type?: RetsListingOfficeUploadRefTypeEnum;
}
...
export class RetsListingOfficeUploadDeleteDto extends RetsListingOfficeEntity implements UploadDeleteDtoCRUDTypeDefinition {
static metaname: string = `${RetsListingOfficeEntity?.metaname}${UploadDeleteArtefact}`;
static metadesc: string = CrudDefMetaDesc.upload_delete_metadesc;
}

// ████ UPLOAD DELETE INPUT DTO ████████████████████████████████████████████████
@InputType()
export class RetsListingOfficeUploadDeleteInputDto extends UploadDeleteInputDto implements UploadDeleteInputArtefactCRUDTypeDefinition {
@Field(() => RetsListingOfficeUploadRefTypeEnum, {nullable: false, description: CrudDefMetaDesc.upload_ref_type})
@IsNotEmpty()
ref_type!: RetsListingOfficeUploadRefTypeEnum;
}
...
@ObjectType()
@Directive('@shareable')
export class RetsListingOfficeUploadDeleteOutputDto extends UploadDeleteOutputDto implements UploadDeleteOutputArtefactCRUDTypeDefinition {
@Field(() => RetsListingOfficeUploadRefTypeEnum, {nullable: true, description: CrudDefMetaDesc.upload_ref_type})
ref_type?: RetsListingOfficeUploadRefTypeEnum;
}