 ...
 **/
    ...
    get sharedAppName(): string {
        return this.get<string>(cnfpub.CONFPUKEY_SHARED_APP_NAME) ?? cnfpub.CONFPUVAL_SHARED_APP_NAME;
    }
    get sharedAppRootDir(): string {
        return this.sharedAppName;
    }
    get sharedAppRootDirPath(): string {
        return path.join(this.microservicesRootDirPath, this.sharedAppRootDir);
    }
    get sharedAppHttpPortExpress(): number {
        return this.get<number>(cnfpub.CONFPUKEY_SHARED_APP_HTTP_PORT_EXPRESS) ?? cnfpub.CONFPUVAL_SHARED_APP_HTTP_PORT_EXPRESS;    
    }
    get sharedAppHttpPortFastify(): number {
        return this.get<number>(cnfpub.CONFPUKEY_SHARED_APP_HTTP_PORT_FASTIFY) ?? cnfpub.CONFPUVAL_SHARED_APP_HTTP_PORT_FASTIFY;
    }
    get sharedAppGrpcPort(): number {
        return this.get<number>(cnfpub.CONFPUKEY_SHARED_APP_GRPC_PORT) ?? cnfpub.CONFPUVAL_SHARED_APP_GRPC_PORT;
    }
    get sharedAppWebsocketPort(): number {
        return this.get<number>(cnfpub.CONFPUKEY_SHARED_APP_WEBSOCKET_PORT) ?? cnfpub.CONFPUVAL_SHARED_APP_WEBSOCKET_PORT;
    }
    get sharedAppDebugPort(): number {
        return this.get<number>(cnfpub.CONFPUKEY_SHARED_APP_DEBUG_PORT) ?? cnfpub.CONFPUVAL_SHARED_APP_DEBUG_PORT;
    }
    get sharedAppBaseUrl(): string {
        return `http://${this.appListenHost}:${this.sharedAppHttpPortExpress}/${this.graphqlRootSlug}`;
    }
    get businessAppName(): string {
        return this.get<string>(cnfpub.CONFPUKEY_BUSINESS_APP_NAME) ?? cnfpub.CONFPUVAL_BUSINESS_APP_NAME;
    }
    get businessAppRootDir(): string {
        return this.sharedAppName;
    }
    get businessAppRootDirPath(): string {
        return path.join(this.microservicesRootDirPath, this.businessAppRootDir);
    }
    get businessAppHttpPortExpress(): number {
        return this.get<number>(cnfpub.CONFPUKEY_BUSINESS_APP_HTTP_PORT_EXPRESS) ?? cnfpub.CONFPUVAL_BUSINESS_APP_HTTP_PORT_EXPRESS;    
    }
    get businessAppHttpPortFastify(): number {
        return this.get<number>(cnfpub.CONFPUKEY_BUSINESS_APP_HTTP_PORT_FASTIFY) ?? cnfpub.CONFPUVAL_BUSINESS_APP_HTTP_PORT_FASTIFY;
    }
    get businessAppGrpcPort(): number {
        return this.get<number>(cnfpub.CONFPUKEY_BUSINESS_APP_GRPC_PORT) ?? cnfpub.CONFPUVAL_BUSINESS_APP_GRPC_PORT;
    }
    get businessAppWebsocketPort(): number {
        return this.get<number>(cnfpub.CONFPUKEY_BUSINESS_APP_WEBSOCKET_PORT) ?? cnfpub.CONFPUVAL_BUSINESS_APP_WEBSOCKET_PORT;
    }
    get businessAppDebugPort(): number {
        return this.get<number>(cnfpub.CONFPUKEY_BUSINESS_APP_DEBUG_PORT) ?? cnfpub.CONFPUVAL_BUSINESS_APP_DEBUG_PORT;
    }
    get businessAppBaseUrl(): string {
        return `http://${this.appListenHost}:${this.businessAppHttpPortExpress}/${this.graphqlRootSlug}`;
    }
    ...
    get disableSupergraphPlayground(): boolean{
        return this.get<boolean>(cnfpub.CONFPUKEY_DISABLE_SUPERGRAPH_PLAYGROUND) ?? cnfpub.CONFPUVAL_DISABLE_SUPERGRAPH_PLAYGROUND;
    }
    get disableSubgraphPlayground(): boolean{
        return this.get<boolean>(cnfpub.CONFPUKEY_DISABLE_SUBGRAPH_PLAYGROUND) ?? cnfpub.CONFPUVAL_DISABLE_SUBGRAPH_PLAYGROUND;
    }
