...
export const CONFPUKEY_DISABLE_SUPERGRAPH_PLAYGROUND: string = 'DISABLE_SUPERGRAPH_PLAYGROUND';
    export const CONFPUVAL_DISABLE_SUPERGRAPH_PLAYGROUND: boolean = true;
export const CONFPUKEY_DISABLE_SUBGRAPH_PLAYGROUND: string = 'DISABLE_SUBGRAPH_PLAYGROUND';
    export const CONFPUVAL_DISABLE_SUBGRAPH_PLAYGROUND: boolean = true;
...
export const CONFPUKEY_COMMON_SECRET: string = 'COMMON_SECRET';
    export const CONFPUVAL_COMMON_SECRET: string = `9BA07E41EB0F2F8B7CF2734283655BFA9FDD73`;
export const CONFPUKEY_COMMON_SALT: string = 'COMMON_SALT';
    export const CONFPUVAL_COMMON_SALT: string = `9CAB98`;
export const CONFPUKEY_COMMON_IV: string = 'COMMON_IV';
    export const CONFPUVAL_COMMON_IV: string = `4FF38661F1064A9A`;
...
export const CONFPUKEY_COOKIE_SECRET: string = 'COOKIE_SECRET';
    export const CONFPUVAL_COOKIE_SECRET: string = `13zBCrd5TV7F/BXCHJN7+FX+DwPHQky6tc9HT2qU786pyPx6K/Dtddp9QsaZO4aL+g==`;
export const CONFPUKEY_SESSION_SECRET: string = 'SESSION_SECRET';
    export const CONFPUVAL_SESSION_SECRET: string = `FEB1369E075FB169A0B0325C2B3312E17833798827`;
...
export const CONFPUKEY_SESSION_IV: string = 'SESSION_IV';
    export const CONFPUVAL_SESSION_IV: string = `AD04DC6A72E874DA272`;
...
export const CONFPUKEY_SHARED_APP_NAME: string = 'SHARED_APP_NAME';
    export const CONFPUVAL_SHARED_APP_NAME: string = 'shared-app';
export const CONFPUKEY_SHARED_APP_HTTP_PORT_EXPRESS: string = 'SHARED_APP_HTTP_PORT_EXPRESS';
    export const CONFPUVAL_SHARED_APP_HTTP_PORT_EXPRESS: number = 4301;
export const CONFPUKEY_SHARED_APP_HTTP_PORT_FASTIFY: string = 'SHARED_APP_HTTP_PORT_FASTIFY';
    export const CONFPUVAL_SHARED_APP_HTTP_PORT_FASTIFY: number = 5301;
export const CONFPUKEY_SHARED_APP_GRPC_PORT: string = 'SHARED_APP_GRPC_PORT';
    export const CONFPUVAL_SHARED_APP_GRPC_PORT: number = 7301;
export const CONFPUKEY_SHARED_APP_WEBSOCKET_PORT: string = 'SHARED_APP_WEBSOCKET_PORT';
    export const CONFPUVAL_SHARED_APP_WEBSOCKET_PORT: number = 20004;
export const CONFPUKEY_SHARED_APP_DEBUG_PORT: string = 'SHARED_APP_DEBUG_PORT';
    export const CONFPUVAL_SHARED_APP_DEBUG_PORT: number = 6301;

export const CONFPUKEY_BUSINESS_APP_NAME: string = 'BUSINESS_APP_NAME';
    export const CONFPUVAL_BUSINESS_APP_NAME: string = 'business-app';
export const CONFPUKEY_BUSINESS_APP_HTTP_PORT_EXPRESS: string = 'BUSINESS_APP_HTTP_PORT_EXPRESS';
    export const CONFPUVAL_BUSINESS_APP_HTTP_PORT_EXPRESS: number = 4302;
export const CONFPUKEY_BUSINESS_APP_HTTP_PORT_FASTIFY: string = 'BUSINESS_APP_HTTP_PORT_FASTIFY';
    export const CONFPUVAL_BUSINESS_APP_HTTP_PORT_FASTIFY: number = 5302;
export const CONFPUKEY_BUSINESS_APP_GRPC_PORT: string = 'BUSINESS_APP_GRPC_PORT';
    export const CONFPUVAL_BUSINESS_APP_GRPC_PORT: number = 7302;
export const CONFPUKEY_BUSINESS_APP_WEBSOCKET_PORT: string = 'BUSINESS_APP_WEBSOCKET_PORT';
    export const CONFPUVAL_BUSINESS_APP_WEBSOCKET_PORT: number = 2302;
export const CONFPUKEY_BUSINESS_APP_DEBUG_PORT: string = 'BUSINESS_APP_DEBUG_PORT';
    export const CONFPUVAL_BUSINESS_APP_DEBUG_PORT: number = 6302;
...
export const CONFPUKEY_JWT_ACCESSTOKEN_SECRET: string = 'JWT_ACCESSTOKEN_SECRET';
    export const CONFPUVAL_JWT_ACCESSTOKEN_SECRET: string = `uifUrG6FfKrXErT59/UyUgjm3kccGeS9yNbsaeS7RUSkdoCWQUn/PSALQ==`;
export const CONFPUKEY_JWT_REFRESHTOKEN_SECRET: string = 'JWT_REFRESHTOKEN_SECRET';
    export const CONFPUVAL_JWT_REFRESHTOKEN_SECRET: string = `cBTveP6NavuAtOMwAm5hPxL0zC4yBC/itlNTQZYdV/7n43F+PMmOaWBpJ0qg==`;
...
export const CONFPUKEY_ENTITY_PREFIX = 'ENTITY_PREFIX';
    export const CONFPUVAL_ENTITY_PREFIX = 'te_';
